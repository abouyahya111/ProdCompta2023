...
public class AjoutReportRemise extends JLayeredPane implements Constantes{
...
private StockPFDAO stockpfDAO;
	...
	public AjoutReportRemise() {
       ...
       tableArticle.setModel(new DefaultTableModel(
       	...
       	new String[] {
       			"Famille","Sous Famille","Article", "Prix Unitaire", "Quantite"
       	}
       ));
       ...
       tableArticle.setRowHeight(20);
		  ...
		  lbllibelle.setFont(new Font("Tahoma", Font.PLAIN, 11));
		   ...
		   AutoCompleteDecorator.decorate(comboArticle);
		      ...
		      txtquantite.setBounds(66, 71, 93, 26);
		      layeredPane.add(txtquantite);
		      
		      JLabel lblPrix = new JLabel("Prix  :");
		      lblPrix.setBounds(351, 71, 34, 26);
		      layeredPane.add(lblPrix);
		      
		      txtPrix = new JTextField();
		      txtPrix.setColumns(10);
		      txtPrix.setBounds(383, 71, 140, 26);
		...
		buttonvalider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			 ...
			 String codeTransfert=Utils.genererCodeTransfer(depot.getCode(),ETAT_TRANSFER_STOCK_AVOIR_R);
		...
		transferStock.setStatut(ETAT_TRANSFER_STOCK_AVOIR_R);
		...
		titledSeparator_2.setTitle("Information Report Remise");
							...
							if(article.getCentreCout2().equals(Constantes.ARTICLE_PACKET))
							{
								existe=true;
							  		...
							  		/// ajout transfer stock PF (Mouvement Stock PF)
										...
										if(existe==true)
										{
											detailTransferStockPF.setPrixUnitaire(new BigDecimal(txtPrix.getText()).divide(article.getConditionnement() , 6, RoundingMode.DOWN));
										...
										detailTransferStockPF.setTypeTransfer(ETAT_TRANSFER_STOCK_AVOIR_R);
	...
	void afficher_tableDetailTransferPF(List<DetailTransferProduitFini> listDetailTransferPF)
	{
		...
		/*		if(article.getCentreCout2()!=null)
			...
			{*/
				Object []ligne={detailTransferPF.getSousFamille().getFamileArticlePF().getLiblle(),detailTransferPF.getSousFamille().getLiblle(),detailTransferPF.getArticle().getLiblle(),detailTransferPF.getPrixUnitaire(),detailTransferPF.getQuantite()};
