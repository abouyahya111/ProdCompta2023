...
public class ConsulterFactureRegularisationAchat extends JLayeredPane implements Constantes{
...
private FournisseurDAO fournisseurdao;
	 ...
	 */
	public ConsulterFactureRegularisationAchat() {
		setOpaque(true);
        ...
        tableArticle.addMouseListener(new MouseAdapter() {
       	...
       	public void mouseClicked(MouseEvent arg0) {
       		...
       		txtMontantHT.setText(tableArticle.getValueAt(tableArticle.getSelectedRow(), 6).toString());
       		txtMontantTVA.setText(tableArticle.getValueAt(tableArticle.getSelectedRow(), 7).toString());
       		txtMontantTTC.setText(tableArticle.getValueAt(tableArticle.getSelectedRow(), 8).toString());
...
/*
       ...
       tableArticle.setRowHeight(20);
				  		     	...
				  		     	scrollPane.setBounds(10, 681, 1375, 255);
				  		     	add(scrollPane);
				  		     	...
				  		     	titledSeparator.setBounds(10, 653, 1458, 30);
				  		     	add(titledSeparator);
				  		     	
				  		     	JLayeredPane layeredPane = new JLayeredPane();
				  		     	layeredPane.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
				  		     	layeredPane.setBounds(10, 489, 1458, 132);
				  		     	add(layeredPane);
				...
				Fournisseur fournisseur=mapFournisseur.get(comboFournisseur.getSelectedItem());
				 int reponse = JOptionPane.showConfirmDialog(null, "Vous voulez vraiment Modifier La facture  ?", 
						...
						
					{
						...
						factureAchatTmp.setEtat(Constantes.TYPE_BON_LIVRAISON_REGULARISATION);
						factureAchatTmp.setType(Constantes.TYPE_BON_LIVRAISON_REGULARISATION);
					    ...
					    */
					    ...
					    JOptionPane.showMessageDialog(null, "Facture de Régularisation d'Achat Modifier avec succée","Satisfaction",JOptionPane.INFORMATION_MESSAGE);
					  //  initialiserFacture();
					    initialiser();
		...
		buttonvalider.setBounds(606, 958, 112, 24);
		add(buttonvalider);
		...
		btnAjouter.setBounds(498, 632, 107, 24);
		add(btnAjouter);
		btnAjouter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				}else 
				{
					...
					if(txtMontantHT.getText().equals(""))
					{
						txtMontantHT.setText("0");
					}
					
					if(txtMontantTVA.getText().equals(""))
					{
						txtMontantTVA.setText("0");
					}
					
					if(txtMontantTTC.getText().equals(""))
					{
						txtMontantTTC.setText("0");
					}
				        	 ...
				        	 if(!txtreduction.getText().equals(""))
					          ...
					          detailFacture.setQuantite(new BigDecimal(txtquantite.getText()));
					           detailFacture.setPrixUnitaire(new BigDecimal(txtPrix.getText()));
							     ...
							     detailFacture.setMontantHT(new BigDecimal(txtMontantHT.getText()).setScale(6, RoundingMode.HALF_UP));
						        detailFacture.setMontantTVA(new BigDecimal(txtMontantTVA.getText()).setScale(6, RoundingMode.HALF_UP));
						        detailFacture.setTva(TVA.multiply(new BigDecimal(100)));
						        detailFacture.setSousFamille(sousfamille);
						       
						        	  detailFacture.setMontantTTC(new BigDecimal(txtMontantTTC.getText()));  
    ...
    while(p<listFamilleArticle.size())
    {
       ...
       i++;
        ...
        layeredPane_2.add(label_12);
	     ...
	     btninitialiser.setBounds(625, 632, 106, 23);
	     add(btninitialiser);
	    ...
	    JLabel label_13 = new JLabel("HT :");
	    label_13.setBounds(10, 96, 72, 26);
	    layeredPane.add(label_13);
	    
	    txtMontantHT = new JTextField();
	    txtMontantHT.setColumns(10);
	    txtMontantHT.setBounds(63, 96, 104, 26);
	    layeredPane.add(txtMontantHT);
	    
	    JLabel label_14 = new JLabel("TVA  :");
	    label_14.setBounds(177, 96, 45, 26);
	    layeredPane.add(label_14);
	    
	    txtMontantTVA = new JTextField();
	    txtMontantTVA.setColumns(10);
	    txtMontantTVA.setBounds(217, 96, 140, 26);
	    layeredPane.add(txtMontantTVA);
	    
	    JLabel label_15 = new JLabel("TTC :");
	    label_15.setBounds(367, 96, 57, 26);
	    layeredPane.add(label_15);
	    
	    txtMontantTTC = new JTextField();
	    txtMontantTTC.setColumns(10);
	    txtMontantTTC.setBounds(424, 96, 112, 26);
	    layeredPane.add(txtMontantTTC);
	    ...
	    button_1.setBounds(234, 985, 112, 24);
	    ...
	    btnReglerLesPrix.setBounds(1389, 802, 106, 23);
...
void chargerListFacture()
{
	...
	listFactureAchat.clear();
		listFactureAchatTmp=factureAchatdao.findByNumFcatureFournisseurDateFactureDepotEtatRegle(txtparnumfacture.getText(),fournisseur, pardateChooser.getDate(), depot,Constantes.TYPE_BON_LIVRAISON_REGULARISATION);
	...
	void initialiser()
	{
	   ...
	   txtquantitepacket.setText("");
	     radiosanstva.setSelected(true);
			...
			txtMontantTVA.setText("");
			txtMontantTTC.setText("");
