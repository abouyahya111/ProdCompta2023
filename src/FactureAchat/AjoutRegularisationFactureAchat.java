...
public class AjoutRegularisationFactureAchat extends JLayeredPane implements Constantes{
...
private StockPFDAO stockpfDAO;
	 ...
	 */
	public AjoutRegularisationFactureAchat() {
		setOpaque(true);
		setBackground(new Color(248, 248, 255));
		setForeground(new Color(248, 248, 255));

		final Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        setBounds(0, 0, 1284, 843);
      ...
      /* 		if(article.getCentreCout2()!=null)
       ...
       tableArticle.setRowHeight(20);
				  		     	...
				  		     	scrollPane.setBounds(10, 444, 1117, 264);
				  		     	add(scrollPane);
				  		     	...
				  		     	titledSeparator.setBounds(10, 403, 1117, 30);
				  		     	add(titledSeparator);
				  		     	
				  		     	JLayeredPane layeredPane = new JLayeredPane();
				  		     	layeredPane.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
				  		     	layeredPane.setBounds(10, 221, 1117, 146);
				  		     	add(layeredPane);
		...
		buttonvalider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				}else
				{
					...
					factureAchat.setEtat(Constantes.TYPE_BON_LIVRAISON_REGULARISATION);
					factureAchat.setType(Constantes.TYPE_BON_LIVRAISON_REGULARISATION);
				    ...
				    */
				    ...
				    JOptionPane.showMessageDialog(null, "Facture Régularisation d'Achat Ajouté avec succée","Satisfaction",JOptionPane.INFORMATION_MESSAGE);
				    initialiserFacture();
				    initialiser();
		...
		buttonvalider.setBounds(475, 719, 112, 24);
		add(buttonvalider);
		...
		titledSeparator_2.setTitle("Information Facture Achat Regularisation");
		titledSeparator_2.setBounds(10, 11, 1117, 30);
		add(titledSeparator_2);
		
		btnAjouter = new JButton("Ajouter");
		btnAjouter.setBounds(478, 378, 107, 24);
		add(btnAjouter);
				        	 ...
				        	 StockPF stockpf=stockpfDAO.findStockByMagasinPFBySousFamille(article.getId(), magasin.getId(),sousfamille.getId());
					        	     ...
					        	     detailFacture.setPrixUnitaire(new BigDecimal(txtPrix.getText()));
								         ...
								         detailFacture.setMontantHT(new BigDecimal(txtMontantHT.getText()).setScale(6, RoundingMode.HALF_UP));
								          ...
								          detailFacture.setMontantTTC(new BigDecimal(txtMontantTTC.getText()).setScale(6, RoundingMode.HALF_UP));
							           ...
							           if(!sousfamille.getCode().equals(Constantes.SOUS_FAMILLE_CONSOMMABLE))
							           {
							        	   ...
							        	   if(stockpf!=null)
								           {
								        	...
								        	QuantiteTotalStock=(QuantiteTotal).add(stockpf.getStock());
								        	   ...
								        	   if(QuantiteTotalStock.compareTo(BigDecimal.ZERO)!=0)
								        	   {
		...
		btnAjouter.setIcon(imgAjouter);
		  ...
		  btnInitialiser.setBounds(609, 377, 106, 23);
		  add(btnInitialiser);
		...
		txttotalmontantTVA.setBounds(993, 752, 134, 26);
