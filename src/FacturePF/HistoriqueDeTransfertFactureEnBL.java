...
public class HistoriqueDeTransfertFactureEnBL extends JLayeredPane implements Constantes{
	...
	private List<HistoriqueTransfertFacturePFEnBL> listHistoriqueTransfertFacturePFEnBL =new ArrayList<HistoriqueTransfertFacturePFEnBL>();
	private List<HistoriqueTransfertDetailFacturePFEnBL> listHistoriqueTransfertDetailFacturePFEnBL =new ArrayList<HistoriqueTransfertDetailFacturePFEnBL>();
...
private List <Object[]> listeObject=new ArrayList<Object[]>();
	...
	public HistoriqueDeTransfertFactureEnBL() {
		setOpaque(true);
	    ...
	    button_1.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent arg0) {
				  ...
				  String titrefeuille="Historique de Transfert Des factures En BL ";
				  ExporterTableVersExcel.tabletoexcelHistoriqueDeTransfertFactureEnBL(table, titre,titrefeuille);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	listHistoriqueTransfertFacturePFEnBL=historiqueTransfertFacturePFEnBLDAO.listeHistoriqueTransfertFacturePFEnBLByRequet(req)	;	
	...
	void afficher_tableFacturePF(List<HistoriqueTransfertFacturePFEnBL> listFacture)
	{
		modelefacture =new DefaultTableModel(
				new Object[][] {
				},
		...
		HistoriqueTransfertFacturePFEnBL facturepf=listFacture.get(i);
		
		Date datefacture=facturepf.getDateFacture();
			
		listHistoriqueTransfertDetailFacturePFEnBL=historiqueTransfertDetailFacturePFEnBLDAO.listeDetailFacturePFByFacture(facturepf.getId());
		...
		for(int j=0;j<listHistoriqueTransfertDetailFacturePFEnBL.size();j++)
		{
			...
			Object []ligne={facturepf.getDateFacture(),facturepf.getNumFacture(),facturepf.getTransfertPar().getNom(),facturepf.getDatetransfertenbl(),facturepf.getClientPF().getNom(),facturepf.getDepot().getLibelle(),facturepf.getMagasin().getLibelle(),MontantTTC};
