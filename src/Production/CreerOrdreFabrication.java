...
//	private Map< String, CategorieMp> mapCategorieMP = new HashMap<>();
	...
	void intialiserTableau() {
		...
		modeleMP = new DefaultTableModel(new Object[][] {}, new String[] { "Code", "Nom Matière Première",
				"Quantité Calculée", "Quantité Existante", "Quantité Manquante", "Quantité A Chargée" }) {
...
/*	}else
	...
	boolean afficherTableMatierePremiereCreerOF(List<CoutMP> listCoutMP) {
		...
		if (!remplirMapQuantiteCharge()) {
			creerOF = false;
			JOptionPane.showMessageDialog(null, "Il faut remplir toutes les quantité avant de créer l'OF", "Erreur",
	...
	private static String registerMailBody() {
		return "<HTML><b>OF N° :</b>" + production.getNumOF() + "<br><br>" + "<br><b>Les détails de l'OF :</b><br>"
				+ "<LI><b>Article : " + production.getArticles().getLiblle() + "</b></LI><br>"
				+ "<LI><b>Code Article : " + production.getArticles().getCodeArticle() + "</b></LI><br>"
				+ "<LI><b>Quantité  : " + production.getQuantiteEstime() + "</b></LI><br>" + "<LI><b>Depot Stockage  : "
	...
	void intialiserTableauMP() {
		modeleMPCAT = new DefaultTableModel(new Object[][] {},
				new String[] { "Code", "Nom Matière Première", "Quantité Estimé" }) {
