					...
					while(j<listChargeProduction.size())	
					{
						...
						if(chargeproduction.getType().equals(Constantes.CHARGEST_FIX))
						{
							...
							while(k<listChargeFixMP.size())
							{
								...
								Object []ligne={detailchargefix.getCharges().getLiblle(),detailchargefix.getMontant(),format.format(coutunitairempfix),format.format(pourcentagefix)+Constantes.POURCENTAGE,format.format(pourcentagedhmpfix)+Constantes.POURCENTAGEDH};
						...
						}else if(chargeproduction.getType().equals(Constantes.CHARGEST_VARIABLE))
						{
							...
							while(l<listChargeVariableMP.size())
							{
								...
								Object []ligne={detailchargevariable.getCharges().getLiblle(),detailchargevariable.getMontant(),format.format(coutunitairempvariable),format.format(pourcentagevariable)+Constantes.POURCENTAGE,format.format(pourcentagedhmpvariable)+Constantes.POURCENTAGEDH};
