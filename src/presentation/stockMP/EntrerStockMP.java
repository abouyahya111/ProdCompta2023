...
*/
		...
		btnBonEntrerMp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				 ...
				 {
					 JOptionPane.showMessageDialog(null, "Il faut saisir les matières premiére", "Erreur", JOptionPane.INFORMATION_MESSAGE);
				 }
...
void intialiserTableau(){
	...
	modeleMP =new DefaultTableModel(
		     	...
		     	new String[] {
		     			"Code","Nom MP","Quantité En Stock","Quantité a Tranférer"
		     	}
		     ) {
