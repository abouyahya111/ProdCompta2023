...
public class ConsulterEtatQuantiteMPTransforme extends JLayeredPane implements Constantes{
...
private DetailTransferMPDAO detailTransferStockMPDAO;
	 ...
	 */
	public ConsulterEtatQuantiteMPTransforme() {
		setOpaque(true);
       ...
       tableEtatStock.setModel(new DefaultTableModel(
       	...
       	new String[] {
				"Matiere Premiere","Famille","Sous Famille","Quantite Sortie","Quantite Dechet","Quantite Offre","Quantite Service","Quantite Dechet Service","Quantite Offre Service","Quantite Avoir", "Quantite Transfer MP PF"
       	}
       ));
       ...
       tableEtatStock.setRowHeight(20);
			...
			public void actionPerformed(ActionEvent e) {
				...
				BigDecimal totalmontantfinale=BigDecimal.ZERO;
				 if(listEtatStockMP.size()!=0)
				 {
						...
						JasperUtils.imprimerEtatQuantiteMPTransforme(listEtatStockMP,parameters);
		...
		JLabel lblConslterLesFactures = new JLabel("           ETAT QUANTITE MP TRANSFORME");
		lblConslterLesFactures.setBackground(Color.WHITE);
		lblConslterLesFactures.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 35));
		lblConslterLesFactures.setBounds(310, 11, 858, 35);
	    ...
	    btnAfficher.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent arg0) {
	    		...
	    		if(magasin!=null)
	    		{
		    		...
		    		if(mp!=null)
		    		{
		    			titre="Etat Quantite MP Transforme Par MP "+mp.getNom() +" au magasin : "+magasin.getLibelle()+ " entre "+d1 +" et "+d2;
		    		}else
		    		{
		    			titre="Etat Quantite MP Transforme Par MP de magasin : "+magasin.getLibelle()+ " entre "+d1+ " et "+d2;
		    		}
		    		...
		    		if(dateChooserdebut.getDate()==null && mp!=null)
		    		{
		    			...
		    			titre="Etat Quantite MP Transforme Par MP de "+mp.getNom() +" au magasin : "+magasin.getLibelle();
		    		}else if(dateChooserdebut.getDate()!=null && dateChooserfin.getDate()==null && mp!=null)
		    		{
		    			String d1=((JTextField)dateChooserdebut.getDateEditor().getUiComponent()).getText();
		    			titre="Etat Quantite MP Transforme Par MP de "+mp.getNom() +" au magasin : "+magasin.getLibelle()+" entre "+d1 +" et "+d1;
		    			
		    		}else if(dateChooserdebut.getDate()!=null && dateChooserfin.getDate()==null && mp==null)
		    		{
		    			String d1=((JTextField)dateChooserdebut.getDateEditor().getUiComponent()).getText();
		    			titre="Etat Quantite MP Transforme Par MP de magasin : "+magasin.getLibelle()+ "entre "+d1 +" et "+d1;
		    		}	
	  ...
	  try {
	    ...
	    btnExporterExcel.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent arg0) {
	    		...
	    		String titre="Etat Quantite MP Transforme "+magasin.getLibelle();
	    		String titrefeuilleexcel="Etat Quantite MP Transforme ";
	    		ExporterTableVersExcel.tabletoexcelEtatQuantiteTransforme(tableEtatStock, titre,titrefeuilleexcel);
	    		}else
	    		{
  			...
  			if(magasin!=null)
	    		{
		    		...
		    		{
		    			dateChooserfin.setCalendar(null);
		    			titre="Etat Quantite MP Transforme Par MP  magasin : "+magasin.getLibelle();
		    		}else if(dateChooserdebut.getDate()!=null && dateChooserfin.getDate()==null && mp!=null)
		    		{
		    			String d1=sdf.format(dateChooserdebut.getDate());
		    			titre="Etat Quantite MP Transforme Par MP de "+mp.getNom() +" au magasin : "+magasin.getLibelle()+" entre "+d1 +" et "+d1;
