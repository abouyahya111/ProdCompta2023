...
public class ConsulterEtatQuantiteMPTransformeParSousFamille extends JLayeredPane implements Constantes{
...
private DetailTransferMPDAO detailTransferStockMPDAO;
	 ...
	 */
	public ConsulterEtatQuantiteMPTransformeParSousFamille() {
		setOpaque(true);
       ...
       tableEtatStock.setRowHeight(20);
		...
		buttonvalider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 ...
				 if(listEtatStockMPParSousFamille.size()!=0)
				 {
						...
						JasperUtils.imprimerEtatQuantiteMPTransforme(listEtatStockMPParSousFamille,parameters);
		...
		JLabel lblConslterLesFactures = new JLabel("           ETAT QUANTITE MP TRANSFORME PAR SOUS FAMILLE");
		lblConslterLesFactures.setBackground(Color.WHITE);
		lblConslterLesFactures.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 35));
		lblConslterLesFactures.setBounds(163, 11, 1312, 35);
	    	...
	    	public void actionPerformed(ActionEvent arg0) {
	    		...
	    		if(magasin!=null)
	    		{
		    		...
		    		if(dateChooserdebut.getDate()==null && mp!=null)
		    		{
		    			...
		    			titre="Etat Quantite MP Transforme Par sous Famille de "+mp.getNom() +" au magasin : "+magasin.getLibelle();
...
//		    	
		    	...
		    	afficher_tableEtatStock(listEtatStockMPParSousFamille);
	    		}
	    		else
	    		{
	  ...
	  try {
	    ...
	    btnExporterExcel.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent arg0) {
	    		...
	    		String titre="Etat Quantite MP Transforme Par Sous famille"+magasin.getLibelle();
	    		String titrefeuilleexcel="Etat Quantite MP Transforme Par Sous famille";
