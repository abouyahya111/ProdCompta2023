					        ...
					        util.Utils.copycollercell(textField);
				  		     			...
				  		     			else
				  		     			{
				  		     				...
				  		     				if(compteMagasinier!=null)
				  		     				{
                                                Date date=dateChooserOperation.getDate();
				  		     					...
				  		     					{
				  		     						JOptionPane.showMessageDialog(null, "Compte Magasinier n'a aucun details au date spécifie","Erreur",JOptionPane.ERROR_MESSAGE);
				  		     						vidertotalettableau();
				  		     					}
				  		     	...
				  		     	btnConsulterCompteMagasinier.addActionListener(new ActionListener() {
				  		     		public void actionPerformed(ActionEvent arg0) {
				  		     			...
				  		     			{
				  		     			 JOptionPane.showMessageDialog(null, "Il n'existe pas aucun detail pour cet magasinier dans cette période!! ", "Erreur", JOptionPane.ERROR_MESSAGE); 
				  		     			}
