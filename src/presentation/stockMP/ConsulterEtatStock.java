	    ...
	    btnAfficher.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent arg0) {
	    		...
	    		if(magasin!=null)
	    		{
		    		...
		    		if(mp!=null)
		    		{
		    			titre="Etat de Stock de "+mp.getNom() +" au magasin : "+magasin.getLibelle()+ " entre "+d1 +" et "+d2;
		    		}else
		    		{
		    		...
		    		if(dateChooserdebut.getDate()==null && mp!=null)
		    		{
		    			...
		    			titre="Etat de Stock de "+mp.getNom() +" au magasin : "+magasin.getLibelle();
		    		}else if(dateChooserdebut.getDate()!=null && dateChooserfin.getDate()==null && mp!=null)
		    		{
		    			String d1=((JTextField)dateChooserdebut.getDateEditor().getUiComponent()).getText();
		    			titre="Etat de Stock de "+mp.getNom() +" au magasin : "+magasin.getLibelle()+" entre "+d1 +" et "+d1;
		    			
		    		}else if(dateChooserdebut.getDate()!=null && dateChooserfin.getDate()==null && mp==null)
		    		{
		    			String d1=((JTextField)dateChooserdebut.getDateEditor().getUiComponent()).getText();
		    			titre="Etat de Stock de magasin : "+magasin.getLibelle()+ "entre "+d1 +" et "+d1;
		    		}	
	  ...
	  try {
	    ...
	    btnExporterExcel.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent arg0) {
	    		...
	    		String titre="Etat de Stock MP "+magasin.getLibelle();
	    		String titrefeuilleexcel="Etat de Stock MP ";
	  ...
	  public void CalculerPrixMoyenFinaleParMouvementStock()
{
	...
	void InitialiseTableauDetailMouvementStock()
	{
		modeleEtatStock =new DefaultTableModel(
				...
				new String[] {
						"Matiere Premiere","Famille","Sous Famille", "Quantite Initial", "Prix Initial","Montant Initial", "Quantite Achat", "Prix Achat","Montant Achat","Quantite Achat", "Prix Achat","Montant Achat","Quantite Sortie", "Prix Sortie","Montant Sortie","Quantite Dechet", "Prix Dechet","Montant Dechet","Quantite Offre", "Prix Offre","Montant Offre","Quantite Service", "Prix Service","Montant Service","Quantite Dechet Service", "Prix Dechet Service","Montant Dechet Service","Quantite Offre Service", "Prix Offre Service","Montant Offre Service" ,"Quantite Avoir", "Prix Avoir","Montant Avoir","Quantite Finale", "Prix Finale","Montant Finale",
				}
			) {
...
/*	void InitialiseTableauMouvementStock()
	...
	void afficher_tableEtatStock(List<EtatStockMP> listEtatStockMP)
	{
		modeleEtatStock =new DefaultTableModel(
				...
				new String[] {
						"Code MP","Matiere Premiere","Famille","Sous Famille","Quantite Initial", "Prix Initial","Montant Initial", "Quantite Achat", "Prix Achat","Montant Achat","Quantite Fabrique", "Prix Fabrique","Montant Fabrique","Quantite Sortie", "Prix Sortie","Montant Sortie","Quantite Dechet", "Prix Dechet","Montant Dechet","Quantite Offre", "Prix Offre","Montant Offre","Quantite Service", "Prix Service","Montant Service","Quantite Dechet Service", "Prix Dechet Service","Montant Dechet Service","Quantite Offre Service", "Prix Offre Service","Montant Offre Service" ,"Quantite Avoir", "Prix Avoir","Montant Avoir","Quantite Finale", "Prix Finale","Montant Finale",
				}
			) {
				boolean[] columnEditables = new boolean[] {
