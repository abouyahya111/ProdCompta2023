...
public class EtatPrixMoyenStockInitialMPParMP extends JLayeredPane implements Constantes{
...
private DetailTransferMPDAO detailTransferStockMPDAO;
	 ...
	 */
	public EtatPrixMoyenStockInitialMPParMP() {
		setOpaque(true);
       ...
       tableEtatStock.setRowHeight(20);
		...
		JLabel lblConslterLesFactures = new JLabel("           Consulter Etat Prix Moyen Stock MP Initial :");
		lblConslterLesFactures.setBackground(Color.WHITE);
		lblConslterLesFactures.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 35));
		lblConslterLesFactures.setBounds(332, 11, 998, 35);
	    ...
	    btnAfficher.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent arg0) {
	    		...
	    		if(magasin!=null)
	    		{
		    		...
		    		if(mp!=null)
		    		{
		    			titre="Etat Prix Moyen Stock Initial de "+mp.getNom() +" au magasin : "+magasin.getLibelle()+ " entre "+d1 +" et "+d2;
		    		}else
		    		{
		    			titre="Etat Prix Moyen Stock Initial de magasin : "+magasin.getLibelle()+ " entre "+d1+ " et "+d2;
		    		}
		    		...
		    		if(dateChooserdebut.getDate()==null && mp!=null)
		    		{
		    			...
		    			titre="Etat Prix Moyen Stock Initial de "+mp.getNom() +" au magasin : "+magasin.getLibelle();
		    		}else if(dateChooserdebut.getDate()!=null && dateChooserfin.getDate()==null && mp!=null)
		    		{
		    			String d1=((JTextField)dateChooserdebut.getDateEditor().getUiComponent()).getText();
		    			titre="Etat Prix Moyen Stock Initial de "+mp.getNom() +" au magasin : "+magasin.getLibelle()+" entre "+d1 +" et "+d1;
		    			
		    		}else if(dateChooserdebut.getDate()!=null && dateChooserfin.getDate()==null && mp==null)
		    		{
		    			String d1=((JTextField)dateChooserdebut.getDateEditor().getUiComponent()).getText();
		    			titre="Etat Prix Moyen Stock Initial de magasin : "+magasin.getLibelle()+ "entre "+d1 +" et "+d1;
		    		}	
	  ...
	  try {
	    ...
	    btnExporterExcel.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent arg0) {
	    		...
	    		String titre="Etat Prix Moyen Stock Initial MP "+magasin.getLibelle();
	    		String titrefeuilleexcel="Etat Prix Moyen Stock Initial MP ";
  			...
  			if(magasin!=null)
	    		{
		    		...
		    		{
		    			dateChooserfin.setCalendar(null);
		    			titre="Etat Prix Moyen Stock Initial  magasin : "+magasin.getLibelle();
		    		}else if(dateChooserdebut.getDate()!=null && dateChooserfin.getDate()==null && mp!=null)
		    		{
		    			String d1=sdf.format(dateChooserdebut.getDate());
		    			titre="Etat Prix Moyen Stock Initial de "+mp.getNom() +" au magasin : "+magasin.getLibelle()+" entre "+d1 +" et "+d1;
