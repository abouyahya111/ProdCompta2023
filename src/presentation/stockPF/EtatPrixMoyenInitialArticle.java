...
public class EtatPrixMoyenInitialArticle extends JLayeredPane implements Constantes{
...
private   JDateChooser audateChooser = new JDateChooser();
	 ...
	 */
	public EtatPrixMoyenInitialArticle() {
		setOpaque(true);
       ...
       FamilleOffre=famillearticleDAo.findByLibelle(FAMILLE_CADEAU);
       FamilleDechet=famillearticleDAo.findByLibelle(FAMILLE_DECHET);
		...
		buttonvalider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
						...
						if(listEtatPrixMoyen.size()!=0)
				{
					...
					parameters.put("titre", "ETAT PRIX MOYEN ACHAT PF");
		...
		JLabel lblConslterLesFactures = new JLabel("                       Etat Prix moyen Initial Article");
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Article","Famille Article", "Sous famille","Quantite total", "prix Moyen","Total HT"
			}
		));
	    		...
	    		if(magasin!=null)
	    		{
		    		...
		    		if(sousfamillearticle!=null)
		    		{
		    			req=req+" and d.sousFamille.id='"+sousfamillearticle.getId()+"' ";
			  			...
			  			afficher_tableEtatPrixMoyen(listEtatPrixMoyen); 
	     ...
	     int p=0;
	      ...
	      btnExporterExcel.addActionListener(new ActionListener() {
	      	public void actionPerformed(ActionEvent arg0) {
				  ...
				  ExporterTableVersExcel.tabletoexcelEtatPrixMoyenAchatArticle(table, titre,titrefeuille);
	...
	void afficher_tableEtatPrixMoyen(List<EtatPrixMoyen> listEtatPrixMoyen)
	{
				...
				{	
					EtatPrixMoyen etatPrixMoyen=listEtatPrixMoyen.get(i);
					 ...
					 Object []ligne={etatPrixMoyen.getArticle(),etatPrixMoyen.getFamille(),etatPrixMoyen.getSousfamille(), etatPrixMoyen.getQuantite(),etatPrixMoyen.getPrix() , etatPrixMoyen.getMontantHT()};
