...
public class ConsulterEtatValeurSystem extends JLayeredPane implements Constantes{
...
private List<EtatStockMP> listEtatStockMP =new ArrayList<EtatStockMP>();
	...
	private List<EtatValeurSystem> listEtatValeurSystem =new ArrayList<EtatValeurSystem>();
...
private FamilleArticlesPFDAO familleArticlesDAO;
	 ...
	 */
	public ConsulterEtatValeurSystem() {
		setOpaque(true);
       ...
       tableEtatStock.setRowHeight(20);
		...
		buttonvalider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 ...
				 if(listEtatValeurSystem.size()!=0)
				 {
			    		...
			    		if(magasinMP!=null && magasinPF!=null )
			    		{
			    		 ...
			    		 titre="Etat Valeur System "+mapMagasin.get(comboMagasinMP.getSelectedItem()).getLibelle() +" Et "+mapMagasin.get(comboMagasinPF.getSelectedItem()).getLibelle();
						...
						JasperUtils.imprimerEtatValeurSystem(listEtatValeurSystem,parameters);
		...
		JLabel lblConslterLesFactures = new JLabel("           Consulter Etat Valeur System :");
	    ...
	    btnAfficher.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent arg0) {
	    		...
	    		afficher_tableEtatStock(listEtatValeurSystem);
	    ...
	    btnExporterExcel.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent e) {
	    		...
	    		String titre="Etat Valeur System "+mapMagasin.get(comboMagasinMP.getSelectedItem()).getLibelle() +" Et "+mapMagasin.get(comboMagasinPF.getSelectedItem()).getLibelle();
	    		String titrefeuille="Etat Valeur System ";
...
if(quantitefinale.add(achat).add(TransferEntrer).add(production).compareTo(BigDecimal.ZERO)!=0)
{
	...
	//System.out.println(listDetailTransferStockPF.get(j).getArticle().getLiblle() + " : "+ listDetailTransferStockPF.get(j).getSousFamille().getLiblle() +" : Prix Moyenne :"+ prixmoyenne );
		...
		{
			JOptionPane.showMessageDialog(null, "Veuillez selectionner le Magasin PF SVP ","Erreur",JOptionPane.ERROR_MESSAGE);
			return;
		}
	...
	void afficher_tableEtatStock(List<EtatValeurSystem> listEtatValeurSystem)
	{
		modeleEtatStock =new DefaultTableModel(
				new Object[][] {
				},
				new String[] {
						"Article","Famille","Sous Famille", "Quantite Initial", "Prix Initial","Montant Initial", "Quantite Achat", "Prix Achat","Montant Achat","Quantite Sortie", "Prix Sortie","Montant Sortie","Quantite Dechet", "Prix Dechet","Montant Dechet","Quantite Offre", "Prix Offre","Montant Offre","Quantite Service", "Prix Service","Montant Service","Quantite Dechet Service", "Prix Dechet Service","Montant Dechet Service","Quantite Offre Service", "Prix Offre Service","Montant Offre Service","Quantite Production", "Prix Production","Montant Production","Quantite Vente", "Prix Vente","Montant Vente", "Quantite Gratuit", "Prix Gratuit","Montant Gratuit","Quantite Avoir", "Prix Avoir","Montant Avoir", "Quantite Transfer MP PF", "Prix Transfer MP PF","Montant Transfer MP PF", "Quantite Finale", "Prix Finale","Montant Finale","Marge %"
				}
			) {
				boolean[] columnEditables = new boolean[] {
		...
		while(i<listEtatValeurSystem.size())
		{	
		EtatValeurSystem etatValeurSystem=listEtatValeurSystem.get(i);
		        ...
		        Object []ligne={etatValeurSystem.getArticle(),etatValeurSystem.getFamille(), etatValeurSystem.getSousFamille(),etatValeurSystem.getQuantiteInitial().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixInitial().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantInitial().setScale(6, RoundingMode.DOWN),etatValeurSystem.getQuantiteAchat().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixAchat().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantAchat().setScale(6, RoundingMode.DOWN),etatValeurSystem.getQuantiteSortie().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixSortie().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantSortie().setScale(6, RoundingMode.DOWN),etatValeurSystem.getQuantiteDechet().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixDechet().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantDechet().setScale(6, RoundingMode.DOWN),etatValeurSystem.getQuantiteOffreProduction().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixOffreProduction().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantOffreProduction().setScale(6, RoundingMode.DOWN),etatValeurSystem.getQuantiteService().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixService().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantService().setScale(6, RoundingMode.DOWN) , etatValeurSystem.getQuantiteDechetService().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixDechetService().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantDechetService().setScale(6, RoundingMode.DOWN),etatValeurSystem.getQuantiteOffreService().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixOffreService().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantOffreService().setScale(6, RoundingMode.DOWN),etatValeurSystem.getQuantiteProduction().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixProduction().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantProduction().setScale(6, RoundingMode.DOWN),etatValeurSystem.getQuantitevente().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixvente().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantvente().setScale(6, RoundingMode.DOWN),etatValeurSystem.getQuantiteGratuit().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixGratuit().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantGratuit().setScale(6, RoundingMode.DOWN),etatValeurSystem.getQuantiteAvoir().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixAvoir().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantAvoir().setScale(6, RoundingMode.DOWN),etatValeurSystem.getQuantiteTransfertMPPF().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixTransfertMPPF().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantTransfertMPPF().setScale(6, RoundingMode.DOWN),etatValeurSystem.getQuantiteFinale().setScale(6, RoundingMode.DOWN),etatValeurSystem.getPrixFinale().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMontantFinale().setScale(6, RoundingMode.DOWN),etatValeurSystem.getMarge()};
...
public void CalculerEtatStockPF()
{
...
public void CalculerEtatStockMP()
{
...
//	
	...
	{
		JOptionPane.showMessageDialog(null, "Veuillez selectionner le Magasin MP SVP ","Erreur",JOptionPane.ERROR_MESSAGE);
		return;
	}
...
public void AfficherEtatMPPF()
{
	...
	EtatValeurSystem etatValeurSystem=new EtatValeurSystem();	
		
	etatValeurSystem.setArticle(etatStockMP.getMp().getNom());	
	etatValeurSystem.setFamille(Famille);  
	etatValeurSystem.setSousFamille(SousFamille); 
	
	etatValeurSystem.setQuantiteProduction(BigDecimal.ZERO);
	etatValeurSystem.setPrixProduction (BigDecimal.ZERO);
	etatValeurSystem.setMontantProduction (BigDecimal.ZERO);
	
	etatValeurSystem.setQuantiteEntrer(BigDecimal.ZERO);
	etatValeurSystem.setPrixEntrer(BigDecimal.ZERO);
	etatValeurSystem.setMontantEntrer(BigDecimal.ZERO);
	
	etatValeurSystem.setQuantiteGratuit(BigDecimal.ZERO);
	etatValeurSystem.setPrixGratuit(BigDecimal.ZERO);
	etatValeurSystem.setMontantGratuit(BigDecimal.ZERO);
	
	etatValeurSystem.setQuantitevente(BigDecimal.ZERO);
	etatValeurSystem.setPrixvente(BigDecimal.ZERO);
	etatValeurSystem.setMontantvente(BigDecimal.ZERO);
	
	
	etatValeurSystem.setQuantiteInitial( etatStockMP.getQuantiteInitial());
	etatValeurSystem.setPrixInitial(etatStockMP.getPrixInitial());  
	etatValeurSystem.setMontantInitial(etatStockMP.getMontantInitial()); 
	etatValeurSystem.setQuantiteAchat(etatStockMP.getQuantiteAchat()); 
	etatValeurSystem.setPrixAchat(etatStockMP.getPrixAchat()); 
	etatValeurSystem.setMontantAchat(etatStockMP.getMontantAchat());  
	etatValeurSystem.setQuantiteSortie(etatStockMP.getQuantiteSortie()); 
	etatValeurSystem.setPrixSortie( etatStockMP.getPrixSortie());
	etatValeurSystem.setMontantSortie(etatStockMP.getMontantSortie()); 
	etatValeurSystem.setQuantiteDechet(etatStockMP.getQuantiteDechet()); 
	etatValeurSystem.setPrixDechet(etatStockMP.getPrixDechet());   
	etatValeurSystem.setMontantDechet(etatStockMP.getMontantDechet());  
	etatValeurSystem.setQuantiteOffreProduction(etatStockMP.getQuantiteOffreProduction());  
	etatValeurSystem.setPrixOffreProduction(etatStockMP.getPrixOffreProduction());  
	etatValeurSystem.setMontantOffreProduction(etatStockMP.getMontantOffreProduction());  
	etatValeurSystem.setQuantiteService( etatStockMP.getQuantiteService());
	etatValeurSystem.setPrixService(etatStockMP.getPrixService()); 
	etatValeurSystem.setMontantService( etatStockMP.getMontantService());
	etatValeurSystem.setQuantiteDechetService( etatStockMP.getQuantiteDechetService());  
	etatValeurSystem.setPrixDechetService(etatStockMP.getPrixDechetService()); 
	etatValeurSystem.setMontantDechetService(etatStockMP.getMontantDechetService());   
	etatValeurSystem.setQuantiteOffreService( etatStockMP.getQuantiteOffreService()); 
	etatValeurSystem.setPrixOffreService(etatStockMP.getPrixOffreService()); 
	etatValeurSystem.setMontantOffreService(etatStockMP.getMontantOffreService()); 
	etatValeurSystem.setQuantiteAvoir(etatStockMP.getQuantiteAvoir()); 
	etatValeurSystem.setPrixAvoir(etatStockMP.getPrixAvoir()); 
	etatValeurSystem.setMontantAvoir(etatStockMP.getMontantAvoir()); 
	etatValeurSystem.setQuantiteTransfertMPPF(etatStockMP.getQuantiteTransfertMPPF()); 
	etatValeurSystem.setPrixTransfertMPPF(etatStockMP.getPrixTransfertMPPF());  
	etatValeurSystem.setMontantTransfertMPPF( etatStockMP.getMontantTransfertMPPF());
	etatValeurSystem.setQuantiteFinale(etatStockMP.getQuantiteFinale()); 
	etatValeurSystem.setPrixFinale(etatStockMP.getPrixFinale()); 
	etatValeurSystem.setMontantFinale(etatStockMP.getMontantFinale());
	etatValeurSystem.setMarge(etatStockMP.getMarge().setScale(2, RoundingMode.HALF_UP).multiply(new BigDecimal(100).setScale(2, RoundingMode.HALF_UP)));
	
	listEtatValeurSystem.add(etatValeurSystem);
...
////////////////////////////////////////////////////////////////////////////////////////////    PF    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	etatValeurSystem.setArticle(etatStockPF.getArticle().getLiblle());	
	etatValeurSystem.setFamille(etatStockPF.getFamilleArticle().getLiblle());  
	etatValeurSystem.setSousFamille(etatStockPF.getSousFamille().getLiblle()); 
	etatValeurSystem.setQuantiteInitial( etatStockPF.getQuantiteInitial());
	etatValeurSystem.setPrixInitial(etatStockPF.getPrixInitial());  
	etatValeurSystem.setMontantInitial(etatStockPF.getMontantInitial()); 
	etatValeurSystem.setQuantiteAchat(etatStockPF.getQuantiteAchat()); 
	etatValeurSystem.setPrixAchat(etatStockPF.getPrixAchat()); 
	etatValeurSystem.setMontantAchat(etatStockPF.getMontantAchat()); 
	
	////////////////////////////// PF ////////////////////////////////////////////////////
	
	etatValeurSystem.setQuantiteProduction(etatStockPF.getQuantiteProduction());
	etatValeurSystem.setPrixProduction (etatStockPF.getPrixProduction());
	etatValeurSystem.setMontantProduction (etatStockPF.getMontantProduction());
	
	etatValeurSystem.setQuantiteEntrer(BigDecimal.ZERO);
	etatValeurSystem.setPrixEntrer(BigDecimal.ZERO);
	etatValeurSystem.setMontantEntrer(BigDecimal.ZERO);
	
	etatValeurSystem.setQuantiteGratuit(etatStockPF.getQuantiteGratuit());
	etatValeurSystem.setPrixGratuit(etatStockPF.getPrixGratuit());
	etatValeurSystem.setMontantGratuit(etatStockPF.getMontantGratuit());
	
	
	////////////////////////////////////////////////////////////////////////////////////////////////
	
	
	etatValeurSystem.setQuantiteSortie(BigDecimal.ZERO ); 
	etatValeurSystem.setPrixSortie(BigDecimal.ZERO );
	etatValeurSystem.setMontantSortie(BigDecimal.ZERO ); 
	
	etatValeurSystem.setQuantitevente(etatStockPF.getQuantiteSortie());
	etatValeurSystem.setPrixvente(etatStockPF.getPrixSortie());
	etatValeurSystem.setMontantvente(etatStockPF.getMontantSortie());
	
	
	
	etatValeurSystem.setQuantiteDechet(BigDecimal.ZERO); 
	etatValeurSystem.setPrixDechet(BigDecimal.ZERO);   
	etatValeurSystem.setMontantDechet(BigDecimal.ZERO);  
	etatValeurSystem.setQuantiteOffreProduction(BigDecimal.ZERO);  
	etatValeurSystem.setPrixOffreProduction(BigDecimal.ZERO);  
	etatValeurSystem.setMontantOffreProduction(BigDecimal.ZERO);  
	etatValeurSystem.setQuantiteService(BigDecimal.ZERO);
	etatValeurSystem.setPrixService(BigDecimal.ZERO); 
	etatValeurSystem.setMontantService(BigDecimal.ZERO);
	etatValeurSystem.setQuantiteDechetService(BigDecimal.ZERO);  
	etatValeurSystem.setPrixDechetService(BigDecimal.ZERO); 
	etatValeurSystem.setMontantDechetService(BigDecimal.ZERO);   
	etatValeurSystem.setQuantiteOffreService(BigDecimal.ZERO); 
	etatValeurSystem.setPrixOffreService(BigDecimal.ZERO); 
	etatValeurSystem.setMontantOffreService(BigDecimal.ZERO); 
	etatValeurSystem.setQuantiteAvoir(etatStockPF.getQuantiteAvoir()); 
	etatValeurSystem.setPrixAvoir(etatStockPF.getPrixAvoir()); 
	etatValeurSystem.setMontantAvoir(etatStockPF.getMontantAvoir()); 
	etatValeurSystem.setQuantiteTransfertMPPF(etatStockPF.getQuantiteEntrer()); 
	etatValeurSystem.setPrixTransfertMPPF(etatStockPF.getPrixEntrer());  
	etatValeurSystem.setMontantTransfertMPPF(etatStockPF.getMontantEntrer());
	etatValeurSystem.setQuantiteFinale(etatStockPF.getQuantiteFinale()); 
	etatValeurSystem.setPrixFinale(etatStockPF.getPrixFinale()); 
	etatValeurSystem.setMontantFinale(etatStockPF.getMontantFinale());
	etatValeurSystem.setMarge(etatStockPF.getMarge().setScale(2, RoundingMode.HALF_UP).multiply(new BigDecimal(100).setScale(2, RoundingMode.HALF_UP)));
