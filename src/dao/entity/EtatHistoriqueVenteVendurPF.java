...
@Entity
@Table(name="detail_facture_PF")
@NamedQuery(name="EtatHistoriqueVenteVendurPF.findAll", query="SELECT d FROM EtatHistoriqueVenteVendurPF d")
public class EtatHistoriqueVenteVendurPF implements Serializable {
	...
	public EtatHistoriqueVenteVendurPF() {
	}
