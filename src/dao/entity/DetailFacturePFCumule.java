...
@Entity
@Table(name="detail_facture_PF_cumule")
@NamedQuery(name="DetailFacturePFCumule.findAll", query="SELECT d FROM DetailFacturePFCumule d")
public class DetailFacturePFCumule implements Serializable {
