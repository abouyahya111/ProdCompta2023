 ...
 */
@Entity
@Table(name="detail_facture_Avoir_ClientPF")
@NamedQuery(name="DetailFactureAvoirClientPF.findAll", query="SELECT d FROM DetailFactureAvoirClientPF d")
public class DetailFactureAvoirClientPF implements Serializable {
