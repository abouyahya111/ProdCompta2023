 ...
 */
@Entity
@Table(name="COMPTEUR_EMPLOYE_PROD")
@NamedQuery(name="CompteurEmployeProd.findAll", query="SELECT d FROM CompteurEmployeProd d")
public class CompteurEmployeProd implements Serializable {
