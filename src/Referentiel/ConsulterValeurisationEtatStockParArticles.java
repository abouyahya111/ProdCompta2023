...
public class ConsulterValeurisationEtatStockParArticles extends JLayeredPane implements Constantes{
...
/**
	 ...
	 */
	public ConsulterValeurisationEtatStockParArticles() {
		setOpaque(true);
       ...
       tableEtatStock.setRowHeight(20);
				  		     	...
				  		     	scrollPane.setBounds(10, 195, 1465, 506);
				  		     	add(scrollPane);
		...
		JLabel lblConslterLesFactures = new JLabel("           VALEURISATION ETAT STOCK / ARTICLES");
...
	    	
	    ...
	    btnExporterExcel.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent e) {
	    		...
	    		String titre="Etat Valeurisation Etat Stock Par Article "+mapMagasin.get(comboMagasinMP.getSelectedItem()).getLibelle() +" Et "+mapMagasin.get(comboMagasinPF.getSelectedItem()).getLibelle();
	    		String titrefeuille="Etat Valeurisation Etat Stock Par Article ";
	    ...
	    btnExporterExcel.setBounds(712, 712, 123, 32);
	    ...
	    lblStockSansEmballage.setBounds(20, 822, 167, 24);
	    ...
	    labelInitial.setBounds(142, 755, 257, 24);
	    add(labelInitial);
	    ...
	    labelInitialEmballage.setBounds(152, 790, 247, 24);
	    ...
	    labelInitialSansEmballage.setBounds(180, 822, 219, 24);
	    ...
	    lblAchatSansEmballage.setBounds(452, 822, 167, 24);
	    ...
	    labelAchatSansEmballage.setBounds(612, 822, 223, 24);
	    ...
	    labelAchatEmballage.setBounds(612, 790, 223, 24);
	    ...
	    labelAchat.setBounds(612, 755, 223, 24);
	    add(labelAchat);
	    ...
	    lblProductionEntrer.setBounds(857, 755, 150, 24);
	    ...
	    lblProductionSortie.setBounds(857, 790, 156, 24);
	    ...
	    lblPrixService.setBounds(857, 822, 167, 24);
	    add(lblPrixService);
	    ...
	    labelPrixService.setBounds(995, 822, 221, 24);
	    ...
	    labelProductionSortie.setBounds(995, 790, 221, 24);
	    ...
	    lblGratuiteEmballage.setBounds(20, 902, 156, 24);
	    ...
	    lblGratuiteSansEmballage.setBounds(20, 934, 179, 24);
	    ...
	    labelGratuiteSansEmballage.setBounds(201, 934, 198, 24);
	    ...
	    labelGratuiteEmballage.setBounds(201, 902, 198, 24);
	    ...
	    lblAvoirSansEmballage.setBounds(439, 934, 179, 24);
	    ...
	    labelAvoirSansEmballage.setBounds(620, 934, 227, 24);
	    ...
	    labelAvoirEmballage.setBounds(620, 902, 227, 24);
	    ...
	    labelAvoir.setBounds(620, 867, 227, 24);
	    add(labelAvoir);
	    ...
	    labelStockfinaleSansEmballage.setBounds(1074, 924, 235, 24);
	    ...
	    lblFinaleSansEmballage.setBounds(893, 924, 179, 24);
	    ...
	    lblStockEmballage_1.setBounds(893, 892, 156, 24);
	    ...
	    lblFinale.setBounds(893, 857, 112, 24);
	    add(lblFinale);
	    ...
	    labelStockFinaleEmballage.setBounds(1074, 892, 235, 24);
	    ...
	    labelStockFinale.setBounds(1074, 857, 235, 24);
	    ...
	    lblAvoirClientPf.setBounds(439, 971, 112, 24);
	    ...
	    labelAvoirClientPF.setBounds(612, 971, 227, 24);
...
// calculer Quantite avoir Client PF et le prix moyen 
	    	...
	    	for(int i=0;i<listDetailTransferStockPFAvoirClientPFGroupebyPF.size();i++)
	    	{
	    		...
	    		prixmoyenavoirClientPF=BigDecimal.ZERO;
	    		for(int j=0;j<listDetailTransferStockPFAvoirClientPF.size();j++)
	    		{
	    			...
	    			if(listDetailTransferStockPFAvoirClientPFGroupebyPF.get(i).getArticle().getId()== listDetailTransferStockPFAvoirClientPF.get(j).getArticle().getId() && listDetailTransferStockPFAvoirClientPFGroupebyPF.get(i).getSousFamille().getId()== listDetailTransferStockPFAvoirClientPF.get(j).getSousFamille().getId())
	    			{
	    				...
	    				prixmoyenavoirClientPF=((prixmoyenavoirClientPF.multiply(quantiteTotalavoirClientPF)).add(listDetailTransferStockPFAvoirClientPF.get(j).getPrixUnitaire().setScale(6, RoundingMode.DOWN).multiply(listDetailTransferStockPFAvoirClientPF.get(j).getQuantite()))).divide(quantiteTotalavoirClientPF.add(listDetailTransferStockPFAvoirClientPF.get(j).getQuantite()),6, RoundingMode.DOWN) ;
	    		...
	    		if(!quantiteTotalavoirClientPF.equals(BigDecimal.ZERO))
	    		{
	    		   	...
	    		   	for(int k=0;k<listEtatStockPF.size();k++)
	    	    	{
	    	    		...
	    	    		if(listEtatStockPF.get(k).getArticle().getId()== listDetailTransferStockPFAvoirClientPFGroupebyPF.get(i).getArticle().getId() && listEtatStockPF.get(k).getSousFamille().getId()== listDetailTransferStockPFAvoirClientPFGroupebyPF.get(i).getSousFamille().getId())
	    	    		{
	    	    			...
	    	    			etatstockpf.setPrixAvoirClient(prixmoyenavoirClientPF);
	    	    			etatstockpf.setMontantAvoirClient(quantiteTotalavoirClientPF.multiply(prixmoyenavoirClientPF));
...
// calculer Quantite avoir Marjane et le prix moyen
		   	...
		   	for(int i=0;i<listEtatStockPF.size();i++)
	    	{
		   	...
		   	if(etatStockPF.getArticle().getCodeArticle().contains(CODE_PRODUIT_FINI_OFFRE))
		   	{
		   		...
		   		if(etatStockPF.getQuantiteInitial().setScale(6).equals(BigDecimal.ZERO.setScale(6)) && etatStockPF.getQuantiteAchat().setScale(6).equals(BigDecimal.ZERO.setScale(6)) && etatStockPF.getQuantiteAvoir().setScale(6).equals(BigDecimal.ZERO.setScale(6)) && etatStockPF.getQuantiteEntrer().setScale(6).equals(BigDecimal.ZERO.setScale(6)) && etatStockPF.getQuantiteProduction().setScale(6).equals(BigDecimal.ZERO.setScale(6)) &&  etatStockPF.getQuantiteSortie().setScale(6).equals(BigDecimal.ZERO.setScale(6)) && etatStockPF.getQuantiteFinale().setScale(6).equals(BigDecimal.ZERO.setScale(6))  && etatStockPF.getQuantiteAvoirClient().setScale(6).equals(BigDecimal.ZERO.setScale(6)))
		   		{
	    		...
	    		for(int i=0;i<listDetailTransferStockPFGroupebyArticle.size();i++)
	    		{
	    			...
	    			{ 
	    				  ...
	    				  if(!avoirClientPF.setScale(6, RoundingMode.DOWN).add(listDetailTransferStockPF.get(j).getQuantite().setScale(6, RoundingMode.DOWN)).setScale(6, RoundingMode.DOWN).equals(BigDecimal.ZERO.setScale(6,RoundingMode.DOWN)))
	                  	   ...
	                  	   {
	                  		 PrixavoirClientPF=BigDecimal.ZERO;
	                  	   }	
