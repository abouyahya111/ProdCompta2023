...
public class ConsulterValeurisationEtatStockParSousFamille extends JLayeredPane implements Constantes{
...
BigDecimal StockAvoirClientPF=BigDecimal.ZERO;
...
JLabel labelAvoirClientPF = new JLabel("");
...
/**
	 ...
	 */
	public ConsulterValeurisationEtatStockParSousFamille() {
		setOpaque(true);
       ...
       tableEtatStock.setModel(new DefaultTableModel(
       	...
       	new String[] {
				"Articles PF","Matiere Premiere","Famille","Sous Famille", "Quantite Initial", "Prix Initial","Montant Initial", "Quantite Achat", "Prix Achat","Montant Achat","Quantite Production", "Prix Production","Montant Production","Quantite Dechet", "Prix Dechet","Montant Dechet","Quantite Offre", "Prix Offre","Montant Offre","Quantite Service", "Prix Service","Montant Service","Quantite Dechet Service", "Prix Dechet Service","Montant Dechet Service","Quantite Offre Service", "Prix Offre Service","Montant Offre Service","Quantite Vente", "Prix Vente","Montant Vente","Quantite Gratuit", "Prix Gratuit","Montant Gratuit","Quantite Avoir", "Prix Avoir","Montant Avoir","Quantite Transfert MP PF", "Prix Transfert MP PF","Montant Transfert MP PF","Quantite Finale", "Prix Finale","Montant Finale"
       	}
       ));
       ...
       tableEtatStock.getColumnModel().getColumn(23).setPreferredWidth(91);
       tableEtatStock.getColumnModel().getColumn(24).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(25).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(26).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(27).setPreferredWidth(92);
       tableEtatStock.getColumnModel().getColumn(28).setPreferredWidth(95);
       ...
       tableEtatStock.getColumnModel().getColumn(31).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(32).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(33).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(34).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(35).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(36).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(37).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(38).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(39).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(40).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(41).setPreferredWidth(99);
       tableEtatStock.getColumnModel().getColumn(42).setPreferredWidth(99);
       ...
       tableEtatStock.setRowHeight(20);
		...
		JLabel lblConslterLesFactures = new JLabel("           VALEURISATION ETAT STOCK / SOUS FAMILLE");
	    	  	...
	    	  	boolean existe=false;
		    		...
		    		if(magasinMP!=null)
		    		{
				  	...
				  	for(int i=0;i<listPrixMoyenStockMP.size();i++)
				  	{
				  		...
				  		etatValeurisationStockParSousFamille.setQuantiteFinale(etatValeurisationStockParSousFamille.getQuantiteInitial().add(etatValeurisationStockParSousFamille.getQuantiteAchat().add(etatValeurisationStockParSousFamille.getQuantiteAvoirClientPF())).subtract(etatValeurisationStockParSousFamille.getQuantiteSortie().add(etatValeurisationStockParSousFamille.getQuantiteDechet().add(etatValeurisationStockParSousFamille.getQuantiteOffreProduction().add(etatValeurisationStockParSousFamille.getQuantiteService().add(etatValeurisationStockParSousFamille.getQuantiteDechetService().add(etatValeurisationStockParSousFamille.getQuantiteOffreService().add(etatValeurisationStockParSousFamille.getQuantiteGratuit().add(etatValeurisationStockParSousFamille.getQuantiteAvoir().add(etatValeurisationStockParSousFamille.getQuantiteTransfertMPPF()))))))))));
				  		if(etatValeurisationStockParSousFamille.getQuantiteInitial().add(etatValeurisationStockParSousFamille.getQuantiteAchat().add(etatValeurisationStockParSousFamille.getQuantiteAvoirClientPF())).compareTo(BigDecimal.ZERO)!=0)
				  		{
				  			
				  			etatValeurisationStockParSousFamille.setPrixFinale((etatValeurisationStockParSousFamille.getMontantInitial().add(etatValeurisationStockParSousFamille.getMontantAchat().add(etatValeurisationStockParSousFamille.getMontantAvoirClientPF()))).divide(etatValeurisationStockParSousFamille.getQuantiteInitial().add(etatValeurisationStockParSousFamille.getQuantiteAchat().add(etatValeurisationStockParSousFamille.getQuantiteAvoirClientPF())), 6, RoundingMode.HALF_UP));
...
{
	exister=false;
EtatVenteParFamilleArticle etatAvoirClientPF=listEtatAvoirClientPF.get(i);
...
if(etatAvoirClientPF.getSousFamilleArticlePF().getLiblle().equals(etatValeurisationStockParSousFamille.getMatierePremiere()))
{


if(etatAvoirClientPF.getSousFamilleArticlePF().getLiblle().equals(etatValeurisationStockParSousFamille.getSousFamille()))
{


	exister=true;

etatValeurisationStockParSousFamille.setQuantiteAvoirClientPF (etatValeurisationStockParSousFamille.getQuantiteAvoirClientPF().add(etatAvoirClientPF.getTotalVente()));
if(etatValeurisationStockParSousFamille.getQuantiteService().add(etatAvoirClientPF.getTotalVente()).compareTo(BigDecimal.ZERO)!=0)
{

etatValeurisationStockParSousFamille.setPrixAvoirClientPF (etatAvoirClientPF.getPrixMoyen());
...
EtatValeurisationStockParSousFamille etatValeurisationStockParSousFamille=new EtatValeurisationStockParSousFamille();
etatValeurisationStockParSousFamille.setType(MAGASIN_CODE_TYPE_PF);
etatValeurisationStockParSousFamille.setMatierePremiere(etatAvoirClientPF.getSousFamilleArticlePF().getLiblle());
etatValeurisationStockParSousFamille.setFamille(etatAvoirClientPF.getFamilleArticlePF().getLiblle());
etatValeurisationStockParSousFamille.setSousFamille(etatAvoirClientPF.getSousFamilleArticlePF().getLiblle());			  		
etatValeurisationStockParSousFamille.setQuantiteInitial(BigDecimal.ZERO);
etatValeurisationStockParSousFamille.setPrixInitial(BigDecimal.ZERO);
etatValeurisationStockParSousFamille.setMontantInitial(BigDecimal.ZERO);
etatValeurisationStockParSousFamille.setQuantiteAchat(BigDecimal.ZERO);
...
etatValeurisationStockParSousFamille.setPrixAvoir(BigDecimal.ZERO);
etatValeurisationStockParSousFamille.setMontantAvoir(BigDecimal.ZERO);
etatValeurisationStockParSousFamille.setQuantiteAvoirClientPF(etatAvoirClientPF.getTotalVente());
etatValeurisationStockParSousFamille.setPrixAvoirClientPF(etatAvoirClientPF.getPrixMoyen());
etatValeurisationStockParSousFamille.setMontantAvoirClientPF(etatAvoirClientPF.getMontant());
etatValeurisationStockParSousFamille.setQuantiteTransfertMPPF(BigDecimal.ZERO);
etatValeurisationStockParSousFamille.setPrixTransfertMPPF(BigDecimal.ZERO);
etatValeurisationStockParSousFamille.setMontantTransfertMPPF(BigDecimal.ZERO);
etatValeurisationStockParSousFamille.setQuantiteFinale(etatValeurisationStockParSousFamille.getQuantiteInitial().add(etatValeurisationStockParSousFamille.getQuantiteAchat().add(etatValeurisationStockParSousFamille.getQuantiteService().add(etatValeurisationStockParSousFamille.getQuantiteTransfertMPPF()).add(etatValeurisationStockParSousFamille.getQuantiteAvoirClientPF()))).subtract(etatValeurisationStockParSousFamille.getQuantiteSortie().add(etatValeurisationStockParSousFamille.getQuantiteDechet().add(etatValeurisationStockParSousFamille.getQuantiteOffreProduction().add(etatValeurisationStockParSousFamille.getQuantiteDechetService().add(etatValeurisationStockParSousFamille.getQuantiteOffreService().add(etatValeurisationStockParSousFamille.getQuantitevente()).add(etatValeurisationStockParSousFamille.getQuantiteGratuit().add(etatValeurisationStockParSousFamille.getQuantiteAvoir()))))))));
...
	    	
	    	...
	    	afficher_tableEtatStock(listEtatValeurisationStockParSousFamille);
	    ...
	    btnExporterExcel.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent e) {
	    		...
	    		String titre="Etat Valeurisation Etat Stock Par Sous famille "+mapMagasin.get(comboMagasinMP.getSelectedItem()).getLibelle() +" Et "+mapMagasin.get(comboMagasinPF.getSelectedItem()).getLibelle();
	    		String titrefeuille="Etat Valeurisation Etat Stock Par Sous famille ";
	    		ExporterTableVersExcel.tabletoexcelEtatValeurisationStock(tableEtatStock, titre,titrefeuille,StockInitial,StockInitialEmballage,StockInitialSansEmballage,StockAchat,StockAchatEmballage,StockAchatSansEmballage,ProductionEntrer,productionSortie,Prixservice,CA,StockGratuite, StockGratuiteEmballage, StockGratuiteSansEmballage,StockAvoir,StockAvoirEmballage,StockAvoirSansEmballage,StockFinale,StockFinaleEmballage,StockFinaleSansEmballage);
	    ...
	    lblStockSansEmballage.setBounds(20, 825, 167, 24);
	    add(lblStockSansEmballage);
	    
	     labelInitial = new JLabel("");
	     labelInitial.setForeground(Color.RED);
	    labelInitial.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelInitial.setBounds(142, 758, 257, 24);
	    add(labelInitial);
	    
	     labelInitialEmballage = new JLabel("");
	     labelInitialEmballage.setForeground(Color.RED);
	    labelInitialEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelInitialEmballage.setBounds(152, 793, 247, 24);
	    add(labelInitialEmballage);
	    
	     labelInitialSansEmballage = new JLabel("");
	     labelInitialSansEmballage.setForeground(Color.RED);
	    labelInitialSansEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelInitialSansEmballage.setBounds(180, 825, 219, 24);
	    add(labelInitialSansEmballage);
	    
	    JLabel lblStockAchat = new JLabel("Stock Achat:");
	    lblStockAchat.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblStockAchat.setBounds(452, 758, 112, 24);
	    add(lblStockAchat);
	    
	    JLabel lblAchatEmballage = new JLabel("Achat Emballage:");
	    lblAchatEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblAchatEmballage.setBounds(452, 793, 156, 24);
	    add(lblAchatEmballage);
	    
	    JLabel lblAchatSansEmballage = new JLabel("Achat Sans Emballage :");
	    lblAchatSansEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblAchatSansEmballage.setBounds(452, 825, 167, 24);
	    add(lblAchatSansEmballage);
	    
	     labelAchatSansEmballage = new JLabel("");
	     labelAchatSansEmballage.setForeground(Color.RED);
	    labelAchatSansEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelAchatSansEmballage.setBounds(612, 825, 223, 24);
	    add(labelAchatSansEmballage);
	    
	     labelAchatEmballage = new JLabel("");
	     labelAchatEmballage.setForeground(Color.RED);
	    labelAchatEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelAchatEmballage.setBounds(612, 793, 223, 24);
	    add(labelAchatEmballage);
	    
	     labelAchat = new JLabel("");
	     labelAchat.setForeground(Color.RED);
	    labelAchat.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelAchat.setBounds(612, 758, 223, 24);
	    add(labelAchat);
	    
	    JLabel lblProductionEntrer = new JLabel("production Entrer :");
	    lblProductionEntrer.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblProductionEntrer.setBounds(857, 758, 150, 24);
	    add(lblProductionEntrer);
	    
	    JLabel lblProductionSortie = new JLabel("Production Sortie:");
	    lblProductionSortie.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblProductionSortie.setBounds(857, 793, 156, 24);
	    add(lblProductionSortie);
	    
	    JLabel lblPrixService = new JLabel("Prix Service :");
	    lblPrixService.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblPrixService.setBounds(857, 825, 167, 24);
	    add(lblPrixService);
	    
	     labelPrixService = new JLabel("");
	     labelPrixService.setForeground(Color.RED);
	    labelPrixService.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelPrixService.setBounds(995, 825, 221, 24);
	    add(labelPrixService);
	    
	     labelProductionSortie = new JLabel("");
	     labelProductionSortie.setForeground(Color.RED);
	    labelProductionSortie.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelProductionSortie.setBounds(995, 793, 221, 24);
	    add(labelProductionSortie);
	    
	     labelProductionEntrer = new JLabel("");
	     labelProductionEntrer.setForeground(Color.RED);
	    labelProductionEntrer.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelProductionEntrer.setBounds(995, 758, 221, 24);
	    add(labelProductionEntrer);
	    
	    JLabel lblCa = new JLabel("CA :");
	    lblCa.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblCa.setBounds(1226, 758, 41, 24);
	    add(lblCa);
	    
	    JLabel label_5 = new JLabel("");
	    label_5.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    label_5.setBounds(1190, 899, 156, 24);
	    add(label_5);
	    
	     labelCA = new JLabel("");
	     labelCA.setForeground(Color.RED);
	    labelCA.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelCA.setBounds(1277, 758, 198, 24);
	    add(labelCA);
	    
	    JLabel lblGratuite = new JLabel("Gratuite :");
	    lblGratuite.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblGratuite.setBounds(20, 870, 112, 24);
	    add(lblGratuite);
	    
	    JLabel lblGratuiteEmballage = new JLabel("Gratuite Emballage:");
	    lblGratuiteEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblGratuiteEmballage.setBounds(20, 905, 156, 24);
	    add(lblGratuiteEmballage);
	    
	    JLabel lblGratuiteSansEmballage = new JLabel("Gratuite Sans Emballage :");
	    lblGratuiteSansEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblGratuiteSansEmballage.setBounds(20, 937, 179, 24);
	    add(lblGratuiteSansEmballage);
	    
	     labelGratuiteSansEmballage = new JLabel("");
	     labelGratuiteSansEmballage.setForeground(Color.RED);
	    labelGratuiteSansEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelGratuiteSansEmballage.setBounds(201, 937, 198, 24);
	    add(labelGratuiteSansEmballage);
	    
	     labelGratuiteEmballage = new JLabel("");
	     labelGratuiteEmballage.setForeground(Color.RED);
	    labelGratuiteEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelGratuiteEmballage.setBounds(201, 905, 198, 24);
	    add(labelGratuiteEmballage);
	    
	     labelGratuite = new JLabel("");
	     labelGratuite.setForeground(Color.RED);
	    labelGratuite.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelGratuite.setBounds(201, 870, 198, 24);
	    add(labelGratuite);
	    
	    JLabel lblAvoir = new JLabel("Avoir :");
	    lblAvoir.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblAvoir.setBounds(440, 860, 112, 24);
	    add(lblAvoir);
	    
	    JLabel lblAvoirEmballage = new JLabel("Avoir Emballage:");
	    lblAvoirEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblAvoirEmballage.setBounds(440, 895, 156, 24);
	    ...
	    lblAvoirSansEmballage.setBounds(440, 927, 179, 24);
	    add(lblAvoirSansEmballage);
	    
	     labelAvoirSansEmballage = new JLabel("");
	     labelAvoirSansEmballage.setForeground(Color.RED);
	    labelAvoirSansEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelAvoirSansEmballage.setBounds(621, 927, 227, 24);
	    add(labelAvoirSansEmballage);
	    
	     labelAvoirEmballage = new JLabel("");
	     labelAvoirEmballage.setForeground(Color.RED);
	    labelAvoirEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelAvoirEmballage.setBounds(621, 895, 227, 24);
	    add(labelAvoirEmballage);
	    
	     labelAvoir = new JLabel("");
	     labelAvoir.setForeground(Color.RED);
	    labelAvoir.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelAvoir.setBounds(621, 860, 227, 24);
	    add(labelAvoir);
	    
	     labelStockfinaleSansEmballage = new JLabel("");
	     labelStockfinaleSansEmballage.setForeground(Color.RED);
	    labelStockfinaleSansEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelStockfinaleSansEmballage.setBounds(1074, 927, 235, 24);
	    add(labelStockfinaleSansEmballage);
	    ...
	    lblFinaleSansEmballage.setBounds(893, 927, 179, 24);
	    add(lblFinaleSansEmballage);
	    
	    JLabel lblStockEmballage_1 = new JLabel("Finale Emballage:");
	    lblStockEmballage_1.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblStockEmballage_1.setBounds(893, 895, 156, 24);
	    add(lblStockEmballage_1);
	    
	    JLabel lblFinale = new JLabel("Stock Finale :");
	    lblFinale.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblFinale.setBounds(893, 860, 112, 24);
	    add(lblFinale);
	    
	     labelStockFinaleEmballage = new JLabel("");
	     labelStockFinaleEmballage.setForeground(Color.RED);
	    labelStockFinaleEmballage.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelStockFinaleEmballage.setBounds(1074, 895, 235, 24);
	    add(labelStockFinaleEmballage);
	    
	     labelStockFinale = new JLabel("");
	     labelStockFinale.setForeground(Color.RED);
	    labelStockFinale.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelStockFinale.setBounds(1074, 860, 235, 24);
	    add(labelStockFinale);
	    
	    JLabel lblAvoirClientPf = new JLabel("Avoir Client PF :");
	    lblAvoirClientPf.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    lblAvoirClientPf.setBounds(440, 959, 179, 24);
	    add(lblAvoirClientPf);
	    
	     labelAvoirClientPF = new JLabel("");
	    labelAvoirClientPF.setForeground(Color.RED);
	    labelAvoirClientPF.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
	    labelAvoirClientPF.setBounds(621, 959, 227, 24);
	    add(labelAvoirClientPF);
...
/*	void InitialiseTableauMouvementStock()
	...
	void afficher_tableEtatStock(List<EtatValeurisationStockParSousFamille> listEtatValeurisationStockParSousFamille)
	{
	...
	SubCategorieMp subCategorieMp=subCategorieMPDAO.findByCode(SOUS_CATEGORIE_MATIERE_PREMIERE_CADEAU) ;	
		
CA=BigDecimal.ZERO;	

StockInitial=BigDecimal.ZERO;
StockInitialEmballage=BigDecimal.ZERO;
StockInitialSansEmballage=BigDecimal.ZERO;
		
StockAchat=BigDecimal.ZERO;
StockAchatEmballage=BigDecimal.ZERO;
StockAchatSansEmballage=BigDecimal.ZERO;
	
 ProductionEntrer=BigDecimal.ZERO;
 productionSortie=BigDecimal.ZERO;
 Prixservice=BigDecimal.ZERO;

 StockGratuite=BigDecimal.ZERO;
 StockGratuiteEmballage=BigDecimal.ZERO;
 StockGratuiteSansEmballage=BigDecimal.ZERO;

 StockAvoir=BigDecimal.ZERO;
 StockAvoirEmballage=BigDecimal.ZERO;
 StockAvoirSansEmballage=BigDecimal.ZERO;
 StockAvoirClientPF=BigDecimal.ZERO;
 
 StockFinale=BigDecimal.ZERO;
 StockFinaleEmballage=BigDecimal.ZERO;
 StockFinaleSansEmballage=BigDecimal.ZERO;
		...
		modeleEtatStock =new DefaultTableModel(
				...
				new String[] {
						"Articles PF","Matiere Premiere","Famille","Sous Famille", "Quantite Initial", "Prix Initial","Montant Initial", "Quantite Achat", "Prix Achat","Montant Achat","Quantite Production", "Prix Production","Montant Production","Quantite Dechet", "Prix Dechet","Montant Dechet","Quantite Offre", "Prix Offre","Montant Offre","Quantite Service", "Prix Service","Montant Service","Quantite Dechet Service", "Prix Dechet Service","Montant Dechet Service","Quantite Offre Service", "Prix Offre Service","Montant Offre Service","Quantite Vente", "Prix Vente","Montant Vente","Quantite Gratuit", "Prix Gratuit","Montant Gratuit","Quantite Avoir", "Prix Avoir","Montant Avoir","Quantite Avoir CLient PF", "Prix Avoir CLient PF","Montant Avoir CLient PF","Quantite Transfert MP PF", "Prix Transfert MP PF","Montant Transfert MP PF","Quantite Finale", "Prix Finale","Montant Finale"
				}
			) {
				boolean[] columnEditables = new boolean[] {
		...
		while(i<listEtatValeurisationStockParSousFamille.size())
		{
			article="";
			EtatValeurisationStockParSousFamille etatValeurisationStockParSousFamille=listEtatValeurisationStockParSousFamille.get(i);
		
			
			
	/////////////////////////////////////////////////////////////////// Somme Chiffre d'Affaire ( Vente ) ///////////////////////////////////////////////////////////////////////////////////////////////////////////////		
			if(etatValeurisationStockParSousFamille.getType().equals(MAGASIN_CODE_TYPE_PF))
			{
				
				CA=CA.add(etatValeurisationStockParSousFamille.getMontantvente());
				
				
			}
			
/////////////////////////////////////////////////////////////////////////////////////////////// Somme Montant Initial   //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
			
			StockInitial=StockInitial.add(etatValeurisationStockParSousFamille.getMontantInitial());
			
////////////////////////////////////////////////////////////////////////////////////////// Somme Montant Initial Emballage   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
			
			if(etatValeurisationStockParSousFamille.getType().equals(MAGASIN_CODE_TYPE_PF))
			{
				if(etatValeurisationStockParSousFamille.getFamille().equals(Constantes.FAMILLE_EMBALLAGE))
				{
					
					StockInitialEmballage=StockInitialEmballage.add(etatValeurisationStockParSousFamille.getMontantInitial());
			...
			if(etatValeurisationStockParSousFamille.getType().equals(MAGASIN_CODE_TYPE_MP))
			{
				if(!etatValeurisationStockParSousFamille.getFamille().equals(Constantes.LIBELLE_FAMILLE_CHAARA) && !etatValeurisationStockParSousFamille.getFamille().equals(Constantes.LIBELLE_FAMILLE_ELNASS) && !etatValeurisationStockParSousFamille.getFamille().equals(Constantes.LIBELLE_FAMILLE_MKARKEB) && !etatValeurisationStockParSousFamille.getFamille().equals(subCategorieMp.getNom()))
				{
...
StockAchat=StockAchat.add(etatValeurisationStockParSousFamille.getMontantAchat());

//////////////////////////////////////////////////////////////////////////////////////////Somme Montant Achat Emballage   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
...
StockAchatEmballage=StockAchatEmballage.add(etatValeurisationStockParSousFamille.getMontantAchat());
...
//////////////////////////////////////////////////////////////////////////////////////////Somme Montant  Production Entrer   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
			
if(etatValeurisationStockParSousFamille.getType().equals(MAGASIN_CODE_TYPE_PF))
{


ProductionEntrer=ProductionEntrer.add(etatValeurisationStockParSousFamille.getMontantService().add(etatValeurisationStockParSousFamille.getMontantOffreService()));
...
//////////////////////////////////////////////////////////////////////////////////////////Somme Montant  Production Sortie   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			

if(etatValeurisationStockParSousFamille.getType().equals(MAGASIN_CODE_TYPE_MP))
{


productionSortie=productionSortie.add(etatValeurisationStockParSousFamille.getMontantService().add(etatValeurisationStockParSousFamille.getMontantOffreService()));
...
/////////////////////////////////////////////////////////////////////////////////////////////// Somme Montant Gratuite   //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			

StockGratuite=StockGratuite.add(etatValeurisationStockParSousFamille.getMontantGratuit());

//////////////////////////////////////////////////////////////////////////////////////////Somme Montant Gratuite Emballage   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
...
StockGratuiteEmballage=StockGratuiteEmballage.add(etatValeurisationStockParSousFamille.getMontantGratuit());
...
StockAvoir=StockAvoir.add(etatValeurisationStockParSousFamille.getMontantAvoir());

/////////////////////////////////////////////////////////////////////////////////////////////// Somme Montant Avoir Client PF   //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			

StockAvoirClientPF=StockAvoirClientPF.add(etatValeurisationStockParSousFamille.getMontantAvoirClientPF());


//////////////////////////////////////////////////////////////////////////////////////////Somme Montant Avoir Emballage   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
...
StockAvoirEmballage=StockAvoirEmballage.add(etatValeurisationStockParSousFamille.getMontantAvoir());
...
/////////////////////////////////////////////////////////////////////////////////////////////// Somme Montant Finale   //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			

StockFinale=StockFinale.add(etatValeurisationStockParSousFamille.getMontantFinale());

//////////////////////////////////////////////////////////////////////////////////////////Somme Montant Finale Emballage   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
...
StockFinaleEmballage=StockFinaleEmballage.add(etatValeurisationStockParSousFamille.getMontantFinale());
...
if(!etatValeurisationStockParSousFamille.getFamille().equals(Constantes.LIBELLE_FAMILLE_CHAARA) && !etatValeurisationStockParSousFamille.getFamille().equals(Constantes.LIBELLE_FAMILLE_ELNASS) && !etatValeurisationStockParSousFamille.getFamille().equals(Constantes.LIBELLE_FAMILLE_MKARKEB) && !etatValeurisationStockParSousFamille.getFamille().equals(subCategorieMp.getNom()))
{
	...
	if(etatValeurisationStockParSousFamille.getArticle()!=null)
	{
		
		article=etatValeurisationStockParSousFamille.getArticle();
	}
			
			
			
			
		        Object []ligne={article,etatValeurisationStockParSousFamille.getMatierePremiere(),etatValeurisationStockParSousFamille.getFamille(),etatValeurisationStockParSousFamille.getSousFamille(),etatValeurisationStockParSousFamille.getQuantiteInitial(),etatValeurisationStockParSousFamille.getPrixInitial(),etatValeurisationStockParSousFamille.getMontantInitial(),etatValeurisationStockParSousFamille.getQuantiteAchat(),etatValeurisationStockParSousFamille.getPrixAchat(),etatValeurisationStockParSousFamille.getMontantAchat(),etatValeurisationStockParSousFamille.getQuantiteSortie(),etatValeurisationStockParSousFamille.getPrixSortie(),etatValeurisationStockParSousFamille.getMontantSortie(),etatValeurisationStockParSousFamille.getQuantiteDechet(),etatValeurisationStockParSousFamille.getPrixDechet(),etatValeurisationStockParSousFamille.getMontantDechet(),etatValeurisationStockParSousFamille.getQuantiteOffreProduction(),etatValeurisationStockParSousFamille.getPrixOffreProduction(),etatValeurisationStockParSousFamille.getMontantOffreProduction(),etatValeurisationStockParSousFamille.getQuantiteService(),etatValeurisationStockParSousFamille.getPrixService(),etatValeurisationStockParSousFamille.getMontantService(),etatValeurisationStockParSousFamille.getQuantiteDechetService(),etatValeurisationStockParSousFamille.getPrixDechetService(),etatValeurisationStockParSousFamille.getMontantDechetService(),etatValeurisationStockParSousFamille.getQuantiteOffreService(),etatValeurisationStockParSousFamille.getPrixOffreService(),etatValeurisationStockParSousFamille.getMontantOffreService(),etatValeurisationStockParSousFamille.getQuantitevente(),etatValeurisationStockParSousFamille.getPrixvente(),etatValeurisationStockParSousFamille.getMontantvente(),etatValeurisationStockParSousFamille.getQuantiteGratuit(),etatValeurisationStockParSousFamille.getPrixGratuit(),etatValeurisationStockParSousFamille.getMontantGratuit(),etatValeurisationStockParSousFamille.getQuantiteAvoir(),etatValeurisationStockParSousFamille.getPrixAvoir(),etatValeurisationStockParSousFamille.getMontantAvoir(),etatValeurisationStockParSousFamille.getQuantiteAvoirClientPF(),etatValeurisationStockParSousFamille.getPrixAvoirClientPF(),etatValeurisationStockParSousFamille.getMontantAvoirClientPF(),  etatValeurisationStockParSousFamille.getQuantiteTransfertMPPF(),etatValeurisationStockParSousFamille.getPrixTransfertMPPF(),etatValeurisationStockParSousFamille.getMontantTransfertMPPF(),etatValeurisationStockParSousFamille.getQuantiteFinale(),etatValeurisationStockParSousFamille.getPrixFinale(),etatValeurisationStockParSousFamille.getMontantFinale() };
	...
	StockInitialSansEmballage=StockInitial.subtract(StockInitialEmballage)	;
	StockAchatSansEmballage=StockAchat.subtract(StockAchatEmballage)	;
	Prixservice=ProductionEntrer.subtract(productionSortie);
	StockGratuiteSansEmballage=StockGratuite.subtract(StockGratuiteEmballage);
	StockAvoirSansEmballage=StockAvoir.subtract(StockAvoirEmballage);
	StockFinaleSansEmballage=StockFinale.subtract(StockFinaleEmballage);
	
	    labelInitial.setText(dfDecimal.format(StockInitial.setScale(6, RoundingMode.HALF_UP))+"");	
		labelInitialEmballage.setText(dfDecimal.format(StockInitialEmballage.setScale(6, RoundingMode.HALF_UP))+"");
		labelInitialSansEmballage.setText(dfDecimal.format(StockInitialSansEmballage.setScale(6, RoundingMode.HALF_UP))+"");
		
		labelAchat.setText(dfDecimal.format(StockAchat.setScale(6, RoundingMode.HALF_UP))+"");	
		labelAchatEmballage.setText(dfDecimal.format(StockAchatEmballage.setScale(6, RoundingMode.HALF_UP))+"");
		labelAchatSansEmballage.setText(dfDecimal.format(StockAchatSansEmballage.setScale(6, RoundingMode.HALF_UP))+"");
		
		labelProductionEntrer.setText(dfDecimal.format(ProductionEntrer.setScale(6, RoundingMode.HALF_UP))+"");	
		labelProductionSortie.setText(dfDecimal.format(productionSortie.setScale(6, RoundingMode.HALF_UP))+"");
		labelPrixService.setText(dfDecimal.format(Prixservice.setScale(6, RoundingMode.HALF_UP))+"");
		
		labelCA.setText(dfDecimal.format(CA.setScale(6, RoundingMode.HALF_UP))+"");
		
		labelGratuite.setText(dfDecimal.format(StockGratuite.setScale(6, RoundingMode.HALF_UP))+"");
		labelGratuiteEmballage.setText(dfDecimal.format(StockGratuiteEmballage.setScale(6, RoundingMode.HALF_UP))+"");
		labelGratuiteSansEmballage.setText(dfDecimal.format(StockGratuiteSansEmballage.setScale(6, RoundingMode.HALF_UP))+"");
		
		labelAvoir.setText(dfDecimal.format(StockAvoir.setScale(6, RoundingMode.HALF_UP))+"");
		labelAvoirEmballage.setText(dfDecimal.format(StockAvoirEmballage.setScale(6, RoundingMode.HALF_UP))+"");
		labelAvoirSansEmballage.setText(dfDecimal.format(StockAvoirSansEmballage.setScale(6, RoundingMode.HALF_UP))+"");
		labelAvoirClientPF.setText(dfDecimal.format(StockAvoirClientPF.setScale(6, RoundingMode.HALF_UP))+"");
		
		labelStockFinale.setText(dfDecimal.format(StockFinale.setScale(6, RoundingMode.HALF_UP))+"");
		labelStockFinaleEmballage.setText(dfDecimal.format(StockFinaleEmballage.setScale(6, RoundingMode.HALF_UP))+"");
		labelStockfinaleSansEmballage.setText(dfDecimal.format(StockFinaleSansEmballage.setScale(6, RoundingMode.HALF_UP))+"");
			...
			if(listDetailFactureVentePFTmp.size()!=0)
			{
				 ...
				 for(int k=0;k<listDetailFactureVentePFTmp.size();k++)
				 {
					 ...
					 if(listDetailFactureVentePF.size()!=0)
					 {
						 ...
						 {
							 if(listDetailFactureVentePF.get(i).getSousFamille().equals(detailfacture.getSousFamille()))
							 {
								 trouve=true;
							 }
			...
			boolean exist=false;
				...
				if(listDetailFactureVentePF.size()!=0)
				{
					...
					for(int j=0;j<listDetailFactureVentePFTmp.size();j++)	
					{
						...
						if(listDetailFactureVentePFTmp.get(j).getSousFamille().equals(sousfamilleArticle))
						{
...
{
if(listDetailFactureAvoirClientPF.get(i).getSousFamille().equals(detailfacture.getSousFamille()))
{
trouve=true;
}
...
if(listDetailFactureAvoirClientPFTmp.get(j).getSousFamille().equals(sousfamilleArticle))
{
