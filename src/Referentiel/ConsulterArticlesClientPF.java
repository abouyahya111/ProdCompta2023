...
public class ConsulterArticlesClientPF extends JLayeredPane implements Constantes{
	 ...
	 */
	public ConsulterArticlesClientPF() {
		setOpaque(true);
        ...
        listDepot = depotDAO.findAll();	
	     ...
	     final Utilisateur utilCreation=AuthentificationView.utilisateur;
				  		...
				  		btnAjouter.setIcon(imgAjouter);
				  		 ...
				  		 btnAjouter.setBounds(460, 250, 114, 26);
				  		 add(btnAjouter);
				  		...
				  		btnInitialiser.setIcon(imgInit);
				  		 ...
				  		 btnInitialiser.setBounds(584, 250, 112, 26);
				  		 add(btnInitialiser);
				  		 ...
				  		 JLayeredPane layeredPane = new JLayeredPane();
				  		   ...
				  		   add(layeredPane);
				  		   		...
				  		   		util.Utils.copycoller(txtCodeArticle);
				  		   			...
				  		   			txtCodeArticle.setBounds(626, 24, 97, 26);
				  		   			...
				  		   			lblCodeClient.setBounds(539, 24, 88, 26);
				  		   			layeredPane.add(lblCodeClient);
				  		   			
				  		   			JScrollPane scrollPane = new JScrollPane((Component) null);
				  		   			scrollPane.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
				  		   			scrollPane.setBounds(29, 287, 1118, 326);
				  		   			add(scrollPane);
		    		                   		 ...
		    		                   		 if(e.getStateChange() == ItemEvent.SELECTED)
		     	 		 {
		    		        		...
		    		        		}else
		    		        		{
								        					...
								        					if(sousfamille.getFamileArticlePF().getLiblle().equals(Constantes.LIBELLE_FAMILLE_CHAARA) || sousfamille.getFamileArticlePF().getLiblle().equals(Constantes.LIBELLE_FAMILLE_MKARKEB) || sousfamille.getFamileArticlePF().getLiblle().equals(Constantes.LIBELLE_FAMILLE_ELNASS))
								        					{
								        						...
								        						if(!article.getLiblle().contains("(OFFRE)"))
								        						{
										        					...
										        					comboArticle.addItem(article.getLiblle());
										        					 mapArticlePF.put(article.getLiblle(), article);
				  		   			...
				  		   			combosousfamille.setBounds(362, 25, 167, 24);
				  		   			 ...
				  		   			 buttonvalider.addActionListener(new ActionListener() {
				  		   			 	public void actionPerformed(ActionEvent e) {
				  		   			 		...
				  		   			 		ArticlesClient articlesClientTmp=articlesClientDAO.findByClientByDepot(clientPF, depot)	;
				  		   			 			...
				  		   			 			if(listDetailArticleClient.size()==0)
				  		   			 			{
				  		   			 				
				  		   			 			articlesClientDAO.delete(articlesClientTmp.getId());
										  		...
										  		comboClientPF.setSelectedItem("");
										  		txtcodeclient.setText("");
							   			 		JOptionPane.showMessageDialog(null, "Les Articles Client Modifier Avec Succée !!!!!","Bravo",JOptionPane.INFORMATION_MESSAGE);
				  		   			 			...
				  		   			 			articlesClientTmp.setDateModifier(new Date());
				  		   			 		articlesClientTmp.setModifierPar(utilisateur);
				  		   			 	articlesClientDAO.edit(articlesClientTmp);
							  		...
							  		txtcodeclient.setText("");
				   			 		JOptionPane.showMessageDialog(null, "Les Articles Client Modifier Avec Succée !!!!!","Bravo",JOptionPane.INFORMATION_MESSAGE);
				  		   			 			...
				  		   			 			{
				  		   			 			JOptionPane.showMessageDialog(null, "Les Articles Client introuvable SVP");
				  		   			 			return;
				  		   			 			}
				  		   			...
				  		   			add(buttonvalider);
				  		   			 ...
				  		   			 btnModifier.addActionListener(new ActionListener() {
	                                       ...
	                                       DetailArticlesClient detailArticlesClient=listDetailArticleClient.get(i);
								  		  ...
								  		  detailArticlesClientDAO.edit(detailArticlesClient);
								  		  afficher_DetailArticlesClient(listDetailArticleClient);
								  		intialiser();
				  		   		...
				  		   		btnModifier.setIcon(imgModifierr);
				  		   			btnModifier.setBounds(1150, 308, 73, 24);
				  		   			...
				  		   			add(btnModifier);
				  		   			 ...
				  		   			 btnSupprimer.addActionListener(new ActionListener() {
				  		   			 	public void actionPerformed(ActionEvent e) {
				  		   			 		...
				  		   			 		{
				  		   			 			DetailArticlesClient detailArticlesClient=listDetailArticleClient.get(table.getSelectedRow());
				  		   			 		detailArticlesClientDAO.delete(detailArticlesClient.getId());
				  		   		...
				  		   		btnSupprimer.setIcon(imgSupprimer);
				  		   			btnSupprimer.setBounds(1150, 338, 73, 24);
				  		      ...
				  		      comboDepot.addItem("");
				  		       ...
				  		       bttnRechercher = new JButton();
				  		      bttnRechercher.addActionListener(new ActionListener() {
				  		      	public void actionPerformed(ActionEvent e) {
				  		      	...
				  		      	Depot depot=mapDepot.get(comboDepot.getSelectedItem());
	  		   			 		...
	  		   			 		articlesClient=articlesClientDAO.findByClientByDepot(clientPF, depot)	;
	  		   			 			
	  		   			 			if(articlesClient==null)
	  		   			 			{
	  		   			 				
	  		   			 				JOptionPane.showMessageDialog (null,"Les Articles Client Introuvable","Erreur",JOptionPane.ERROR_MESSAGE);
	  		   			 				return;
	  		   			 			}else
	  		   			 			{
	  		   			 				
	  		   			 			listDetailArticleClient=detailArticlesClientDAO.listeDetailArticlesClientByArticlesClient(articlesClient.getId());	
	  		   			 			afficher_DetailArticlesClient(listDetailArticleClient);
				  		      ...
				  		      bttnRechercher.setFont(new Font("Tahoma", Font.PLAIN, 11));
				  		     bttnRechercher.setIcon(imgRechercher);
				  		      bttnRechercher.setBounds(1166, 67, 57, 33);
				  		      add(bttnRechercher);
