...
public class EtatMoyenValeurisationProduction extends JLayeredPane implements Constantes{
...
private   JDateChooser audateChooser = new JDateChooser();
	 ...
	 */
	public EtatMoyenValeurisationProduction() {
		setOpaque(true);
		setBackground(new Color(248, 248, 255));
		setForeground(new Color(248, 248, 255));

		final Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        setBounds(0, 0, 1614, 1062);
	   ...
	   transferStockMPDAO=new TransferStockMPDAOImpl();
		...
		buttonvalider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
						...
						if(listEtatPrixMoyenAfficher.size()!=0)
				{
					...
					parameters.put("titre", "ETAT MOYEN VALEURISATION PRODUCTION");
					parameters.put("datedebut",datedebutFacture);
					parameters.put("dateFin", dateFinFacture);
					JasperUtils.imprimerEtatMoyenValeurisationProduction(listEtatPrixMoyenAfficher,parameters);
		...
		JLabel lblConslterLesFactures = new JLabel("                       Etat Moyen Valeurisation Production");
		lblConslterLesFactures.setBackground(Color.WHITE);
		lblConslterLesFactures.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 35));
		lblConslterLesFactures.setBounds(381, 11, 1038, 35);
		add(lblConslterLesFactures);
		
		JScrollPane scrollPane_1 = new JScrollPane((Component) null);
		scrollPane_1.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		scrollPane_1.setBounds(10, 154, 1573, 427);
		add(scrollPane_1);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
					"Code Article","Article","Famille Article", "Sous famille","Quantite Production", "prix Moyen", "Montant HT"
			}
		));
		...
		CalculerPrixMoyenPF();
				  			...
				  			afficher_tableEtatPrixMoyen(listEtatPrixMoyenAfficher); 
	    ...
	    layeredPane_2.setBounds(10, 57, 1573, 51);
	    add(layeredPane_2);
	    ...
	    lblDateFacture.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 12));
			     		...
			     		if(magasin!=null )
			     		{
			     			if(!comboparfamille.getSelectedItem().equals(""))
			     			{
			     				...
			     				if(comboparfamille.getSelectedIndex()!=-1)
			     				{
			     						...
			     						if(famillearticle.getLiblle().equals(FAMILLE_CADEAU))
			     						{
			     							listSousFamilleArticle=sousfamillearticleDAO.findAll();
			     						}else
			     						{
	     ...
	     comboparfamille.setBounds(754, 16, 150, 24);
	     ...
	     labelarticle.setBounds(1205, 15, 70, 24);
	     layeredPane_2.add(labelarticle);
	     
	      comboarticle = new JComboBox();
	     comboarticle.setBounds(1261, 16, 302, 24);
	    ...
	    comboparfamille.addItem("");
	     ...
	     int p=0;
	      ...
	      SousFamilleCombo.setSelectedIndex(-1);
	      SousFamilleCombo.setBounds(1029, 15, 166, 24);
	      ...
	      lblSousFamilleArticle.setBounds(914, 15, 132, 24);
	      ...
	      btnExporterExcel.addActionListener(new ActionListener() {
	      	public void actionPerformed(ActionEvent arg0) {
				  ...
				  String
				  titre="Etat Moyen Valeurisation Production "+mapMagasin.get(combomagasin.getSelectedItem()).getLibelle(); 
				  String titrefeuille="Etat Moyen Valeurisation Production ";
...
dudateChooser.setCalendar(null);
 ...
 InitialiseTableauFacture();	
	...
	void afficher_tableEtatPrixMoyen(List<EtatPrixMoyen> listEtatPrixMoyen)
	{
				...
				{	
					EtatPrixMoyen etatPrixMoyen=listEtatPrixMoyen.get(i);
				
					 Object []ligne={etatPrixMoyen.getCodeArticle(),etatPrixMoyen.getArticle(),etatPrixMoyen.getFamille(), etatPrixMoyen.getSousfamille(),etatPrixMoyen.getQuantite() ,etatPrixMoyen.getPrix(),etatPrixMoyen.getMontantHT()};
