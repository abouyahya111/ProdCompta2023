...
public class EtatPrixMoyenAvoirFamilleArticle extends JLayeredPane implements Constantes{
	...
	private List<DetailFactureAvoirPF> listDetailFacture =new ArrayList<DetailFactureAvoirPF>();
	private List<DetailFactureAvoirPF> listDetailFactureTmp =new ArrayList<DetailFactureAvoirPF>();
	 ...
	 */
	public EtatPrixMoyenAvoirFamilleArticle() {
		setOpaque(true);
        ...
        try{
	     ...
	     final Utilisateur utilCreation=AuthentificationView.utilisateur;
				  		   		...
				  		   		table.getColumnModel().getColumn(3).setPreferredWidth(123);
										...
										parameters.put("titre", "Etat de Prix Moyen Avoir Par Sous Famille Article");
										JasperUtils.imprimerEtatVenteFamilleArticle(listEtatAvoir,parameters);
								 ...
								 }else
								 {
				  		   		...
				  		   		btnImprimer.setIcon(imgImprimer);
				  		   			...
				  		   			lblEtatDeVente = new JLabel("             Etat de Prix Moyen Avoir Par Sous Famille Article");
				  		   			lblEtatDeVente.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 35));
				  		   			lblEtatDeVente.setBackground(Color.WHITE);
				  		   			lblEtatDeVente.setBounds(100, 40, 1132, 35);
				  		   			add(lblEtatDeVente);
				  		   			...
				  		   			button_1.addActionListener(new ActionListener() {
					  					...
					  					if(dateDebut.equals(""))	{
					  						...
					  						JOptionPane.showMessageDialog(null, "Il faut choisir Date Fin", "Erreur", JOptionPane.ERROR_MESSAGE);
					  							...
					  							listEtatAvoir.clear();
					  							listDetailFactureTmp=detailfactureAvoirdao.listeDetailFactureAvoirByDate(dateChooserdebut.getDate(), dateChooserfin.getDate(), magasin);
					  							...
					  							if(listDetailFactureTmp.size()!=0)
					  							{
						  							 ...
						  							 {
						  								 DetailFactureAvoirPF detailfacture=listDetailFactureTmp.get(k);
						  								 trouve=false;
						  						...
						  						boolean existe=false;
						  							...
						  							if(listDetailFacture.size()!=0)
						  							{
						  								...
						  								afficher_tableEtatVenteArticle(listEtatAvoir);
				  				  ...
				  				  btnExporterExcel.addActionListener(new ActionListener() {
				  					  ...
				  					  if(magasin!=null) {
				  						...
				  						if(listEtatAvoir.size()!=0)
				  						  ...
				  						  String
					  					  titre="Etat Avoir Par Sous Famille Article "+mapMagasin.get(combomagasin.getSelectedItem()).getLibelle(); 
					  					  String titrefeuille="Etat Avoir Par Sous Famille Article PF ";
