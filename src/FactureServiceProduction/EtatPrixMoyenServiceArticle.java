...
public class EtatPrixMoyenServiceArticle extends JLayeredPane implements Constantes{
...
private   JDateChooser audateChooser = new JDateChooser();
	 ...
	 */
	public EtatPrixMoyenServiceArticle() {
		setOpaque(true);
       ...
       stockpfDAO=ProdLauncher.stockPFDAO;
		...
		JLabel lblConslterLesFactures = new JLabel("                       Etat Prix moyen Achat Article");
			    		...
			    		if(	DateUtils.nbJoursEntre(dudateChooser.getDate(), audateChooser.getDate())>=0)
			    		{
			    			...
			    			if(comboarticle.getSelectedIndex()!=-1)
			    			{
				    			...
				    			}else
				    			{
				  				...
				  				listeObject=detailFactureAchatPfdao.listeEtatPrixMoyen(dudateChooser.getDate(), audateChooser.getDate(),magasin,famillearticle,article, TousFamille,TousArticle, sousfamillearticle , TousSousFamille);
 ...
 InitialiseTableauFacture();	
	...
	void afficher_tableEtatPrixMoyen(List<Object[]> listEtatPrixMoyen)
	{
				...
				{	
					 ...
					 Object []ligne={object[0],object[1],object[2], object[3],new BigDecimal(object[4].toString()) , new BigDecimal(object[5].toString()),new BigDecimal(object[6].toString()),new BigDecimal(object[7].toString())};
