...
public class EtatFacturesServiceDetaile extends JLayeredPane implements Constantes{
...
private   JDateChooser audateChooser = new JDateChooser();
	 ...
	 */
	public EtatFacturesServiceDetaile() {
		setOpaque(true);
		...
		buttonvalider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(listDetailFactureServiceProduction.size()!=0)
				{
						...
						JasperUtils.imprimerEtatFactureService(table.getModel(), parameters); 
...
txtNumfacture.setText("");
 InitialiseTableauFacture();	
	...
	void chargerListeFacture()
	{
	    ...
	    afficher_tableFactureServiceProduction(listDetailFactureServiceProduction);
	...
	void afficher_tableFactureServiceProduction(List<DetailFactureServiceProduction> listDetailFactureServiceProduction)
	{
				...
				DetailFactureServiceProduction detailfactureServiceProduction=listDetailFactureServiceProduction.get(i);
				 ...
				 if(detailfactureServiceProduction.getFactureService().getNumFacture().equals("082/2023"))
				 {
	...
	Production production=productionDAO.findByNumOF(detailfactureServiceProduction.getFactureService().getNumOF(),detailfactureServiceProduction.getFactureService().getDepot().getCode());
						...
						.equals(Constantes.SOUS_CATEGORIE_MATIERE_PREMIERE_THE))
					{
							...
							
						{
							...
							Object []ligneTmp={detailfactureServiceProduction.getFactureService().getDateFacture(),detailfactureServiceProduction.getFactureService().getNumFacture(),detailfactureServiceProduction.getFactureService().getClient().getNom(),"OFFRE",ListedetailTransferProduitFini.get(0).getSousFamille().getLiblle(),  article.getLiblle(),coutMP.getQuantiteOffre(),detailfactureServiceProduction.getPrix(),detailfactureServiceProduction.getPrix().multiply(coutMP.getQuantiteOffre()) , montantTVA, montantTTC };
				...
				}else if(detailfactureServiceProduction.getArticle().trim().equals(THERRES.getNom().trim()) )
				{
					...
					Object []ligne={detailfactureServiceProduction.getFactureService().getDateFacture(),detailfactureServiceProduction.getFactureService().getNumFacture(),detailfactureServiceProduction.getFactureService().getClient().getNom(),"OFFRE",THERRES.getNom(),  detailfactureServiceProduction.getArticle(),detailfactureServiceProduction.getQuantite(),detailfactureServiceProduction.getPrix(),detailfactureServiceProduction.getMontantHT() , montantTVA, montantTTC};
				...
				}else if(detailfactureServiceProduction.getArticle().trim().equals(VERRES.getNom().trim()) )
				{
					...
					Object []ligne={detailfactureServiceProduction.getFactureService().getDateFacture(),detailfactureServiceProduction.getFactureService().getNumFacture(),detailfactureServiceProduction.getFactureService().getClient().getNom(),"OFFRE",VERRES.getNom(),  detailfactureServiceProduction.getArticle(),detailfactureServiceProduction.getQuantite(),detailfactureServiceProduction.getPrix(),detailfactureServiceProduction.getMontantHT() , montantTVA, montantTTC };
