...
public class EtatFacturesService extends JLayeredPane implements Constantes{
...
private   JDateChooser audateChooser = new JDateChooser();
    ...
    private static XSSFCell CellNumFactureOld;
    private static XSSFCell CellNumFactureNew;
...
*/
	...
	JOptionPane.showMessageDialog(null, "Modification effectué");
	     ...
	     txtlien.setBounds(379, 823, 216, 20);
	     add(txtlien);
	     ...
	     btnOpen.setBounds(605, 822, 89, 23);
	     add(btnOpen);
	     ...
	     btnValider.addActionListener(new ActionListener() {
	     	...
	     	CellNumFactureOld=ExcelWSheet.getRow(i).getCell(0);
	     	CellNumFactureNew=ExcelWSheet.getRow(i).getCell(7);
	     	CellDate=ExcelWSheet.getRow(i).getCell(1);
	     	 

	     	DataFormatter dataFormatter = new DataFormatter();
	     	String formattedCellStr = dataFormatter.formatCellValue(CellNumFactureOld);
	     	if(formattedCellStr!=null && formattedCellStr.isEmpty()==false && !formattedCellStr.equals(""))
	     	{
	     	 
	  FactureServiceProduction factureServiceProduction=factureServiceProductiondao.findByNumFcatureByDate(CellNumFactureOld.getStringCellValue(), CellDate.getDateCellValue());
...
if(factureServiceProduction!=null)
{
	...
	production.setNumFacture(CellNumFactureNew.getStringCellValue());
	factureServiceProduction.setNumFacture(CellNumFactureNew.getStringCellValue());
	factureServiceProductiondao.edit(factureServiceProduction);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	     				  					
	     ...
	     btnValider.setBounds(280, 822, 89, 23);
	     add(btnValider);
 ...
 InitialiseTableauFacture();	
	...
	Production production=productionDAO.findByNumOF(detailfactureServiceProduction.getFactureService().getNumOF(),detailfactureServiceProduction.getFactureService().getDepot().getCode());
					...
					BigDecimal montantTTC=BigDecimal.ZERO;
										...
										{
											montantTVA=detailfactureServiceProduction.getQuantite().multiply(detailfactureServiceProduction.getPrix()).multiply(new BigDecimal(0.2)).setScale(6, RoundingMode.HALF_UP);
											
											
										}
										
										montantTTC=detailfactureServiceProduction.getQuantite().multiply(detailfactureServiceProduction.getPrix()).add(montantTVA);
					
					
					
					
					Object []ligne={detailfactureServiceProduction.getFactureService().getDateFacture(),detailfactureServiceProduction.getFactureService().getNumFacture(),detailfactureServiceProduction.getFactureService().getClient().getNom(),ListedetailTransferProduitFini.get(0).getSousFamille().getFamileArticlePF().getLiblle(),ListedetailTransferProduitFini.get(0).getSousFamille().getLiblle(),  detailfactureServiceProduction.getArticle(),detailfactureServiceProduction.getQuantite(),detailfactureServiceProduction.getPrix(),detailfactureServiceProduction.getPrix().multiply(detailfactureServiceProduction.getQuantite()) , montantTVA, montantTTC };
