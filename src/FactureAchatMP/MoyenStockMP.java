...
public class MoyenStockMP extends JLayeredPane implements Constantes{
...
private   JDateChooser audateChooser = new JDateChooser();
	...
	public MoyenStockMP() {
       ...
       sousFamilleEnVracDAO=new SousFamilleEnVracDAOImpl();
		...
		buttonvalider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					if(magasin!=null )
					{
						...
						if(listPrixMoyenStockMP.size()!=0)
				{
					...
					parameters.put("titre", " MOYEN STOCK MP");
					parameters.put("datedebut",datedebutFacture);
					parameters.put("dateFin", dateFinFacture);
					JasperUtils.imprimerMoyenStockMP(listPrixMoyenStockMP,parameters);
		...
		JLabel lblConslterLesFactures = new JLabel("                           Moyen Stock MP");
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
					"Code MP","MP","Categorie","Sous categorie","Famille","sous Famille", "Quantite Initial","Prix Initial","Montant HT", "Quantite Achat","Prix Moyen Achat","Montant HT", "Quantite Finale","Prix Moyen","Montant HT"
			    		...
			    		if(	DateUtils.nbJoursEntre(dudateChooser.getDate(), audateChooser.getDate())>=0)
			    		{
			  			...
			  			for(int j=0;j<listPrixMoyenStockMP.size();j++)	
			  			{
			  				...
			  				if(etatInitialParSousCtaegorieMP.getSousFamilleArticlePF().equals(moyenStockMP.getSousfamille()))
			  				{
				  				...
				  				afficher_tableEtatPrixMoyen(listPrixMoyenStockMP); 
	     ...
	     int p=0;
	      ...
	      btnExporterExcel.addActionListener(new ActionListener() {
	      	public void actionPerformed(ActionEvent arg0) {
				  ...
				  ExporterTableVersExcel.tabletoexcelEtatMoyenStockMP(table, titre,titrefeuille);
